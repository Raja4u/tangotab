...
<body onload="getLoginCookie();setCookie('landing','1044',0);" onclick="clickedBody(this.id);">
              ...
              <tbody><tr>
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tbody><tr>
                    <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="center" valign="top" scope="row" style="padding-left: 20px;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="left" valign="top"  scope="row">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td align="left" valign="top" scope="row" class="text_homebold_01-1">Game Day Special - $18! </td>
                              </tr>
                              <tr>
                                <td align="left" valign="top" class="text_homebold_02_1" scope="row">Bucket of Beer, Chips &amp; Salsa &amp; 2 Hot Dogs </td>
                              </tr>
                              <tr>
                                <td align="left" valign="top" scope="row" class="text_homebold_01-2"> Thu/Fri 6:00PM-11:00PM, Sat/Sun 12:00PM-4:00PM </td>
                              </tr>
                            </table></td>
                            <td align="center" rowspan=2 valign="top" scope="row">
                            
                            <img src="../images/corner.png"   width="280" height="205"  border="0" />
                              <div class="text_homebold_1_address" >4830 McKinney Ave. Dallas, TX 75205 </div></td>
                          </tr>
                            ...
                            <td colspan="2"  align="center" valign="top" scope="row"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                ...
                                <td height="30" align="center" valign="middle" class="text_homebold_02" scope="row">
                                    THURSDAY</td>
                                    <td height="30" align="center" valign="middle" class="calender" scope="row"><span class="text_homebold_02">
                                    FRIDAY</span></td>
                                    <td height="30" align="center" valign="middle" class="calender" scope="row"><span class="text_homebold_02">
                                    SATURDAY</span></td>
                                    <td height="30" align="center" valign="middle" class="calender" scope="row"><span class="text_homebold_02">
                                  ...
                                  <tr>
                                    ...
                                    <span class="text_homebold_01">19</span>
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td align="center" valign="top" scope="row"><span class="at-text">@ Tigers 6:05 PM</span></td>
                                        </tr>
                                              <tr>
                                          <td align="center" valign="top" scope="row"> 
                                         <a href="javascript:sendDeal('650','04/19/2012');"  class="text_homebold_01"><img src="../images/claimnow_btn.png" style="padding: 5px;"  border="0"/></a></td>
                                        </tr>
                                      </table></td>
                                    <td width="150" height="65" align="center" valign="middle" class="calender" scope="row">
                                      ...
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td align="center" valign="top" scope="row"><span class="at-text">@ Tigers 6:05 PM</span></td>
                                              ...
                                              <tr>
                                          <td align="center" valign="top" scope="row"> 
                                         <a href="javascript:sendDeal('650','04/20/2012');"  class="text_homebold_01"><img src="../images/claimnow_btn.png" style="padding: 5px;"  border="0"/></a></td>
                                        </tr>
                                      </table></td>
                                    <td height="85" align="center" valign="middle" class="calender" scope="row">
                                    <span class="text_homebold_01">21</span>
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td align="center" valign="top" scope="row"><span class="at-text">@ Tigers 12:05 PM</span>
                                        </td>
                                        </tr>
                                         ...
                                         <a href="javascript:sendDeal('651','04/21/2012');"  class="text_homebold_01">
                                         <img src="../images/claimnow_btn.png" style="padding: 5px;"  border="0"/></a>
                                         </td>
                                        </tr>
                                      </table></td>
                                    <td width="150" height="65" align="center" valign="middle" class="calender" scope="row">
                                      ...
                                      <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tr>
                                          <td align="center" valign="top" scope="row"><span class="at-text">@ Tigers 6:05 PM</span></td>
                                              ...
                                              <tr>
                                          <td align="center" valign="top" scope="row"> 
                                         <a href="javascript:sendDeal('651','04/22/2012');"  class="text_homebold_01">
