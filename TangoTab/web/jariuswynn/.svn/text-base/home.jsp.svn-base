...
<body id="body" topmargin="0" bottommargin="0" onload="setCookie('landing','1016',0);"  onclick="clickedBodyUtil();">
                        ...
                        <table width="70%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            ...
                            <table width="81%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  <td align="left" valign="middle" scope="col"><img src="images/jariswynn_txt_img.png" width="400" height="150" border="0" /></td>
                                </tr>
                            </table></td>
                        ...
                        <td width="300" height="480" align="center" valign="top" style="background:url('../images/fb_signup_bg.png') no-repeat center top;" scope="row">
                         ...
                         <html:form  action="jsp/userReg.do?type=consumer" method="post" onsubmit="return Onsubmit1();">
                            ...
                            <tr>
                              ...
                              <tr>
                            <td>
                            <html:hidden property="refferCode"  value="1016" styleId="refferCode"/>
