...
String emailTo = "rathnakar.p@techgene.com";
 ...
 String HOLDER_EMAIL="#HOLDER_EMAIL#";
     String personalMail="";
     String personalHeader=" SJE Referral Friend";
	 String mail = "";
	...
	+ "<a  href='http://www.tangotab.com/sje'>here</a> to signup and start receiving these exclusive offers today! "
