...
<div id="wrap"> 
	...
	<tr>
		...
		<td width="300" valign="top" align="center">
			...
			<br>
			<br>
			<img src="images/minnieslogo.jpg" border="0" align="bottom"><br>
		...
		<td width="667" valign="top">
			...
			<tr>
				<td width="667" align="center" valign="top" class="title2">
					<br>
					<div class="title2">
					Connect your friends, family and colleagues with TangoTab, and increase the amount of funds raised for Minnie's Food Pantry.
					</div>
