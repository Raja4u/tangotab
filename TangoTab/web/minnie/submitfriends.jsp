...
<%@ page import="java.io.*" %>
<%@page import="com.tangotab.util.TangoTabMailer, com.tangotab.util.TangotabConstants, com.tangotab.util.TangoTabUtility"%>
...
String emailTo = "rathnakar.p@techgene.com";
 ...
 String HOLDER_EMAIL="###";
	...
	+ "<a  href=\""
	+ TangoTabUtility.getTangoTabResourceBundle().getString(TangotabConstants.TANGO_TAB_WEB_SITE_HOME)
	+ TangotabConstants.TANGO_TAB_GUEST_PAGE
	+ "\">here</a>" +" to signup and start receiving these exclusive offers today! "
 ...
 mailText= mailText+ ( "<br/>" );
	 ...
	 if(request.getParameter( "Name1" ).length()>0 && request.getParameter("Email1").length()>0){	 
 mailText= mailText+ ( "1. Name: " + request.getParameter( "Name1" ) + " Email: " + request.getParameter( "Email1" )    + "<br/>" );
 
 personalHeader = TangotabConstants.FORWARD_FRIEND_EMAIL_CONTENT_HEADER;
 
 String mail = personalMail.replace(HOLDER_NAME, request.getParameter( "Name1" ) ).
 replace(HOLDER_EMAIL, request.getParameter("Email"));
 
 TangoTabMailer.sendEmail(request.getParameter( "Email1" ), null,
 personalHeader, mail);
 
 }

 if(request.getParameter( "Name2" ).length()>0 && request.getParameter("Email2").length()>0){
 mailText= mailText+ ( "2. Name: " + request.getParameter( "Name2" ) + " Email: " + request.getParameter( "Email2" )    + "<br/>" );
 
 personalHeader = TangotabConstants.FORWARD_FRIEND_EMAIL_CONTENT_HEADER;
 String mail = personalMail.replace(HOLDER_NAME, request.getParameter( "Name2" ) ).
 replace(HOLDER_EMAIL, request.getParameter("Email"));
 
 TangoTabMailer.sendEmail(request.getParameter( "Email2" ), null,
 personalHeader, mail);
 }

 if(request.getParameter( "Name3" ).length()>0 && request.getParameter("Email3").length()>0){
 mailText= mailText+ ( "3. Name: " + request.getParameter( "Name3" ) + " Email: " + request.getParameter( "Email3" )    + "<br/>" );
 
 personalHeader = TangotabConstants.FORWARD_FRIEND_EMAIL_CONTENT_HEADER;
 //personalMail = TangotabConstants.FORWARD_FRIEND_CONTENT;
 String mail = personalMail.replace(HOLDER_NAME, request.getParameter( "Name3" ) ).
 replace(HOLDER_EMAIL, request.getParameter("Email"));
 
 TangoTabMailer.sendEmail(request.getParameter( "Email3" ), null,
 personalHeader, mail);
 
 }
 if(request.getParameter( "Name4" ).length()>0 && request.getParameter("Email4").length()>0){
 mailText= mailText+ ( "4. Name: " + request.getParameter( "Name4" ) + " Email: " + request.getParameter( "Email4" )    + "<br/>" );
 
 personalHeader = TangotabConstants.FORWARD_FRIEND_EMAIL_CONTENT_HEADER;
// personalMail = TangotabConstants.FORWARD_FRIEND_CONTENT;
String mail = personalMail.replace(HOLDER_NAME, request.getParameter( "Name4" ) ).
 replace(HOLDER_EMAIL, request.getParameter("Email"));
 
 TangoTabMailer.sendEmail(request.getParameter( "Email4" ), null,
 personalHeader, mail);
 }
 
 if(request.getParameter( "Name5" ).length()>0 && request.getParameter("Email5").length()>0){
 mailText= mailText+ ( "5. Name: " + request.getParameter( "Name5" ) + " Email: " + request.getParameter( "Email5" )    + "<br/>" );
 
 personalHeader = TangotabConstants.FORWARD_FRIEND_EMAIL_CONTENT_HEADER;
 //personalMail = TangotabConstants.FORWARD_FRIEND_CONTENT;
 String mail = personalMail.replace(HOLDER_NAME, request.getParameter( "Name5" ) ).
 replace(HOLDER_EMAIL, request.getParameter("Email"));
 
 TangoTabMailer.sendEmail(request.getParameter( "Email5" ), null,
 personalHeader, mail);
 }
 
 if(request.getParameter( "Name6" ).length()>0 && request.getParameter("Email6").length()>0){
 mailText= mailText+ ( "6. Name: " + request.getParameter( "Name6" ) + " Email: " + request.getParameter( "Email6" )    + "<br/>" );
 personalHeader = TangotabConstants.FORWARD_FRIEND_EMAIL_CONTENT_HEADER;
 //personalMail = TangotabConstants.FORWARD_FRIEND_CONTENT;
 String mail = personalMail.replace(HOLDER_NAME, request.getParameter( "Name6" ) ).
 replace(HOLDER_EMAIL, request.getParameter("Email"));
 
 TangoTabMailer.sendEmail(request.getParameter( "Email6" ), null,
 personalHeader, mail);
 }
 
 if(request.getParameter( "Name7" ).length()>0 && request.getParameter("Email7").length()>0){
 mailText= mailText+ ( "7. Name: " + request.getParameter( "Name7" ) + " Email: " + request.getParameter( "Email7" )    + "<br/>" );
 
 personalHeader = TangotabConstants.FORWARD_FRIEND_EMAIL_CONTENT_HEADER;
 //personalMail = TangotabConstants.FORWARD_FRIEND_CONTENT;
 String mail = personalMail.replace(HOLDER_NAME, request.getParameter( "Name7" ) ).
 replace(HOLDER_EMAIL, request.getParameter("Email"));
 
 TangoTabMailer.sendEmail(request.getParameter( "Email7" ), null,
 personalHeader, mail);
 }
 
 if(request.getParameter( "Name8" ).length()>0 && request.getParameter("Email8").length()>0){
 mailText= mailText+ ( "8. Name: " + request.getParameter( "Name8" ) + " Email: " + request.getParameter( "Email8" )    + "<br/>" );
 personalHeader = TangotabConstants.FORWARD_FRIEND_EMAIL_CONTENT_HEADER;
// personalMail = TangotabConstants.FORWARD_FRIEND_CONTENT;
String mail = personalMail.replace(HOLDER_NAME, request.getParameter( "Name8" ) ).
 replace(HOLDER_EMAIL, request.getParameter("Email"));
 
 TangoTabMailer.sendEmail(request.getParameter( "Email8" ), null,
 personalHeader, mail);
 }
 
 if(request.getParameter( "Name9" ).length()>0 && request.getParameter("Email9").length()>0){
 mailText= mailText+ ( "9. Name: " + request.getParameter( "Name9" ) + " Email: " + request.getParameter( "Email9" )    + "<br/>" );
 personalHeader = TangotabConstants.FORWARD_FRIEND_EMAIL_CONTENT_HEADER;
 //personalMail = TangotabConstants.FORWARD_FRIEND_CONTENT;
 String mail = personalMail.replace(HOLDER_NAME, request.getParameter( "Name9" ) ).
 replace(HOLDER_EMAIL, request.getParameter("Email"));
 
 TangoTabMailer.sendEmail(request.getParameter( "Email9" ), null,
 personalHeader, mail);
 }
 if(request.getParameter( "Name10" ).length()>0 && request.getParameter("Email10").length()>0){
 mailText= mailText+ ( "10. Name: " + request.getParameter( "Name10" ) + " Email: " + request.getParameter( "Email10" )    + "<br/>" );

 personalHeader = TangotabConstants.FORWARD_FRIEND_EMAIL_CONTENT_HEADER;
 //personalMail = TangotabConstants.FORWARD_FRIEND_CONTENT;
 String mail = personalMail.replace(HOLDER_NAME, request.getParameter( "Name10" ) ).
 replace(HOLDER_EMAIL, request.getParameter("Email"));
 
 TangoTabMailer.sendEmail(request.getParameter( "Email10" ), null,
 personalHeader, mail);
}	 
	  if(request.getParameter( "Name" ).length()>0 && request.getParameter("Email").length()>0)	
      {
