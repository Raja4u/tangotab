...
var checker = {
 ...
 if(ua.indexOf('iPhone') != -1 || ua.indexOf('iPod') != -1  
   ...
   //window.location="http://www.tangotab.com/mobile/nyc/";
...
{
document.frm.action='<fmt:message key='website.home'></fmt:message>/searchForward.do';
document.frm.submit();
}
...
<body onload="getLoginCookie();setCookie('landing','1048',0);" >
