...
<div id="wrap"> 
		...
		<td bgcolor="#000000" align="left" valign="middle" width="467">
			...
			<tr>
				<td bgcolor="#000000" align="right" valign="bottom" class="normalwhite">
					...
					<a href="http://www.tangotab.com/" class="normalwhite" style="text-decoration:none;">
						Our Charities
					</a>
	...
	<tr>
		...
		<td width="300" valign="top" align="center">
			...
			<br>
			<br>
			<img src="images/w2wlogo.jpg" border="0" align="bottom">
			<br>
		...
		<td width="667" valign="top">
			...
			<tr>
				<td width="667" align="center" valign="top" class="title2">
					...
					And increase the amount of funds raised to feed the world’s hungry.  
					</div>
			...
			<tr>
				<td colspan="3" align="center" valign="top" class="normalblack">
					...
					<form action="submitreferfriends.jsp" method="post" name="RegistrationForm" onSubmit="return validate();">
