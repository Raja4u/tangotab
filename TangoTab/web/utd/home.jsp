...
<body id="body" topmargin="0" bottommargin="0" onload="setCookie('landing','1037',0);"  onclick="clickedBodyUtil();">
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <html:form  action="jsp/userReg.do?type=consumer" method="post" onsubmit="return Onsubmit1();">
							...
							<html:hidden property="refferCode"  value="1037" styleId="refferCode"/>
                            ...
                            <html:text property="firstname" 
                          	...
                          	<tr>
									<td> 	<html:text property="lastname" value="Last Name"	
													...
													<tr>
														<td><html:text property="emailId" value="Email"  onblur="checkEmail(4,this.value)" 	 styleClass="text_box" styleId="emailId"   onchange="removetext(this,'Email');"  onkeyup="clickedFormUtil(this,'Email');"  onclick="clickedFormUtil(this,'Email');"  ></html:text> 
												                     </td></tr>
													<tr><td > 
                    ...
                    <td align="center" valign="top" height="445" ><table width="600" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="498" height="500" align="right" valign="top" style="background:url('images/howtotango_bgutd.png') no-repeat;">
                        <table width="72%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
                            <td height="149" align="left" valign="top">&nbsp;</td>
                          </tr>
                          <tr>
                            ...
                            <td valign="bottom"><img src="images/ut-dallas.gif" width="100" height="40" border="0"/>
                            </td>
                            </tr>
                            </table>
                            </td>
