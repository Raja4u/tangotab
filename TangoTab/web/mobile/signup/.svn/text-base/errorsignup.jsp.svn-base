...
<script type='text/javascript' src='<fmt:message key="dwr.url"></fmt:message>/dwr/interface/DealDescr.js'></script>
	<link href='<fmt:message key="website.home"></fmt:message>mobile/signup/css/styles.css' rel="stylesheet" type="text/css" />
...
function signup()
{
document.getElementById("signupdata").style.display="inline";
 ...
 <html:form  action="jsp/userReg.do?type=consumer" method="post" onsubmit="return Onsubmit1();">
	  <table width="320" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr><td><table><tr>
          <td width="50%" align="left" valign="top" scope="row"><img src="<fmt:message key='website.home'></fmt:message>/mobile/signup/images/logo.png" alt="Tangotab" width="160" height="71" class="padding1" /></td>
          ...
          <table width="100%" border="0">
             ...
             <!--  <tr>
              ...
              <tr>
                <td align="center" valign="top" class="" scope="row"><a href="#" onclick="Onsubmit1();"><img src="<fmt:message key='website.home'></fmt:message>/mobile/signup/images/signup_btn.png" alt="Sign Up" border="0"></a></td>
              </tr>
	  ...
	  <div id="signupclose" style="display:inline;">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <table width="320" border="0" cellspacing="0" cellpadding="0">
        <tbody><tr>
          <td align="center" valign="top" scope="row"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td align="center" valign="top" scope="row"><img src="<fmt:message key='website.home'></fmt:message>mobile/images/topimg1.png" alt="img" width="320" height="74"></td>
            </tr>
            
            <tr>
              <td align="center" valign="top" scope="row"><div class="text5">HELP END HUNGER&#13;</div></td>
            </tr>
            
            <tr>
              <td align="center" valign="top" scope="row"><table width="75%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="41%" align="left" valign="top" scope="row"><img src="<fmt:message key='website.home'></fmt:message>/mobile/images/tangotab_logo_1.png" alt="img" width="110" height="37"></td>
                  <td width="59%" align="center" valign="middle" class="text6" scope="row">and you can do it:</td>
                </tr>
                <tr>
                  <td colspan="2" align="left" valign="top" scope="row"><table width="100%" border="0" cellspacing="0" cellpadding="4">
                    <tr>
                      <td width="12%"   align="right" valign="top" scope="row"><img src="<fmt:message key='website.home'></fmt:message>/mobile/images/1.png" alt="img" width="25" height="25"></td>
                      
                      <td width="84%"   align="left" valign="top" class="text6" scope="row">You sign up for <span class="text7">free. </span></td>
                    </tr>
                    <tr>
                      <td  align="right" valign="top" scope="row"><img src="<fmt:message key='website.home'></fmt:message>/mobile/images/2.png" alt="img" width="25" height="25"></td>
                      
                      <td  align="left" valign="top" class="text6" scope="row">You get <span class="text7">great deals</span> at your favorite restaurants. </td>
                    </tr>
                    <tr>
                      <td   align="right" valign="top" scope="row"><img src="<fmt:message key='website.home'></fmt:message>/mobile/images/3.png" alt="img" width="25" height="25"></td>
                     
                      <td  align="left" valign="top" class="text6" scope="row">When you redeem an <br>offer, we <span class="text7">feed a person in need.</span> </td>
                    </tr>
                  </table></td>
                  </tr>
              </table></td>
            ...
            <tr>
              <td align="center" valign="top" class="text8" scope="row"> </td>
            </tr>
            <tr>
              <td align="center"  height="8" svalign="top" scope="row"></td>
            </tr>
            <tr>
              <td align="center" valign="top" scope="row"><a href="javascript:signup();"><img src="<fmt:message key='website.home'></fmt:message>/mobile/images/signupforfree_btn.png" alt="btn" width="251" height="45" border="0"></a></td>
            </tr>
          </table></td>
              </tr>
              <tr>
