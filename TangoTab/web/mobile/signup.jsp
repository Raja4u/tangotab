	  ...
	  <table width="320" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="center" valign="top" scope="row"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center" valign="top" scope="row" class="text1">FREE SERVICE </td>
              </tr>
              <tr>
                <td align="center" valign="top" class="text1" scope="row">FREE OFFERS </td>
              </tr>
              <tr>
                <td align="center" valign="top" class="text2" scope="row">GREAT CAUSE</td>
