...
var checker = {
 ...
 if(ua.indexOf('iPhone') != -1 || ua.indexOf('iPod') != -1  
  ...
  // window.location="http://www.tangotab.com/mobile/nifb/";
...
<body onload="getLoginCookie();setCookie('landing','1047',0);" onclick="clickedBody(this.id);">
            ...
            <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tbody><tr>
                          ...
                          <tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							 <tr>
                              ...
                              <tr>
                                <td height="15" colspan="3" align="left" valign="top" scope="row"></td>
                              </tr>
							  <tr> 
				...
				<h1 style="line-height: 44px; font-family: calibri;"><span style="font-size:61px;"><a href="<fmt:message key='website.home'></fmt:message>jsp/searchForward.do"  style="color:#000000;text-decoration:none;">&nbsp;Free&nbsp;Restaurant&nbsp;Deals.</a></span>
                           ...
                           <div id="Layer2"><img src="<fmt:message key='website.home'></fmt:message>/images/NIFB_Logo_2_ashx.png"   /></div> </td>
							...
							<input type="hidden" name="emailIdexists"	 id="emailIdexists" />			
									...
									<table width="65%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            ...
                                            <html:hidden property="refferCode"  value="1047" styleId="refferCode" /> 
