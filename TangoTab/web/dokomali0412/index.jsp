...
<body onload="getLoginCookie();setCookie('landing','1046',0);" onclick="clickedBody(this.id);">
              ...
              <tbody><tr>
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tbody><tr>
                    <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="center" valign="top" scope="row" style="padding-left: 20px;"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="left" valign="top"  scope="row"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td align="left" valign="top" scope="row" class="text_homebold_01-1">50% OFF Lunch! </td>
                              </tr>
                              <tr>
                                <td align="left" valign="top" class="text_homebold_02_1" scope="row">Enjoy an Awesome Lunch &amp; Take 50% OFF. </td>
                              </tr>
                              <tr>
                                <td align="left" valign="top" scope="row" class="text_homebold_01-2">11:00AM until 3:00PM </td>
                              </tr>
                            </table></td>
                            <td align="center" valign="top" scope="row">
                            <img src="../images/komali.png" alt="img" width="277" height="113" border="0" /></td>
                          </tr>
                            ...
                            <td colspan="2" align="center" valign="top" scope="row"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td colspan="2" align="left" valign="top" class="text_homebold_02_1" scope="row" >Select the day - 
                                 <div class="text_homebold_1_address" id="Layer1"> 4152 Cole Ave. Dallas, TX 75204
                                  </div></td>
                              </tr>
                              <tr>
                                  ...
                                  <tr>
                                    ...
                                    <span class="text_homebold_01">19</span>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td align="center" valign="top" scope="row">
                                              <a href="javascript:sendDeal('657','04/19/2012');"  class="text_homebold_01">
                                    ...
                                    <span class="text_homebold_01">20</span>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td align="center" valign="top" scope="row">
                                              <a href="javascript:sendDeal('657','04/20/2012');"  class="text_homebold_01">
                                         <img src="../images/claimnow_btn.png" style="padding: 5px;"  border="0"/></a></td>
                                          </tr>
                                      </table></td>
                                    ...
                                    21</span>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td align="center" valign="top" scope="row">
                                              <a href="javascript:sendDeal('657','04/21/2012');"  class="text_homebold_01">
                                         <img src="../images/claimnow_btn.png" style="padding: 5px;"  border="0"/></a></td>
                                          </tr>
                                      </table></td>
                                    <td width="150" height="65" align="center" valign="middle" class="calender" scope="row">
                                    <span class="text_homebold_01">22</span>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td align="center" valign="top" scope="row">
                                              <a href="javascript:sendDeal('657','04/22/2012');"  class="text_homebold_01">
                                         <img src="../images/claimnow_btn.png" style="padding: 5px;"  border="0"/></a></td>
                                          </tr>
                                      </table></td>
                                  </tr>
