...
<div id="wrap"> 
	...
	<tr>
		...
		<!------------------------------ LEFT COLUMN ------------------------------>
		<td width="300" valign="top" align="center" class="left_border">
			
			<table align="center" ><tr><td align="center" >
			<a href="http://www.m_inniesfoodpantry.org" target="_blank">
				<img src="images/hands.jpg" width="295" height="199" border="0" class="img_border">
		  </a><br>  
          </td><tr><td  style="font-size:25px;color:#000000" align="center" > 
          <img src="images/whenyoueat.gif" width="277"   border="0" align="bottom" height="76"> 
          </td></tr><tr><td align="center" >
	    <img src="images/left_images.gif" width="277"   border="0" align="bottom" height="76">
			
		
        <a href="#"><img src="images/mailogo.png" width="270" height="187" border="0" align="bottom"></a>
 
			 
			<br></tr><tr><td   style="font-size:25px;color:#000000" align="center">
			    <img src="images/workingtogether.gif" width="270" height="140" border="0" align="bottom">
		</td></table></td>
		
		<!------------------------------ RIGHT COLUMN ------------------------------>
		<td width="667" background="images/index_bg1.jpg" valign="top">
		
			<table cellpadding="10" cellspacing="0" border="0" width="667" align="center" height="70" style="height:70px; padding:10px;">
			<tr>
				<td width="667" valign="middle" align="center" class="largewhite">
					<br>
				  <br>
					<br>
			...
			<tr>
				<td width="667" valign="top" align="right" class="white_madium">
				      ...
				      <table width="320" border="0" cellspacing="0" cellpadding="0">
				        ...
				        <tr>
				          <td height="50" align="left" valign="top"><a href="signup.jsp"><img src="images/signup.png" width="170" height="30" border="0" align="absmiddle"></a>
				
			            </tr>
				        <tr>
				          <td align="left" valign="top"><a href="referfriends.jsp"><img src="images/refer.png" width="170" height="30" border="0" align="absmiddle"></a></td>
			            </tr>
				        <tr>
				          <td height="150">&nbsp;</td>
			            </tr>
			...
			<tr>
				<td width="667" valign="middle" align="left" class="largewhite">
					
					<font style="font-family: bradley Hand ITC;font: bold;font-weight:bold;">
						Together&hellip; <br>
					we can make a difference<br></font>
				</td>
			</tr>
			</table>
