	 ...
	 mailText= mailText+ ( "Email: " + request.getParameter( "Email" ) + "<br />" );
	  ...
	  mailText= mailText+ ( "Phone Number: " + request.getParameter( "Phone" ) + "<br />" );
	   ...
	   TangoTabMailer.sendEmail(emailTo,
					null, 
					"TangoTab.com MERCHANT ALLIANCE User Registration", mailText); 
...
<div id="wrap"> 
		...
		<td bgcolor="#000000" align="left" valign="middle" width="467">
			...
			<tr>
				<td bgcolor="#000000" align="right" valign="bottom" class="normalwhite">
					...
					<a href="http://www.tangotab.com/mai/referfriends.jsp" class="normalwhite" style="text-decoration:none;">
						Refer a Friend
					</a>
					&nbsp;&nbsp;|&nbsp;&nbsp;
	...
	<table cellpadding="10" cellspacing="0" border="9" width="967" align="center" bgcolor="#ffffff" height="70" style="height:70px;">
	<tr>
	  <td align="center" valign="top" background="images/submitsignup.jpg" height="558">
