...
var checker = {
 ...
 if(ua.indexOf('iPhone') != -1 || ua.indexOf('iPod') != -1 || ua.indexOf('iPad') != -1 
   ...
   window.location="http://www.tangotab.com/mobile/toronto/";
...
<body onload="getLoginCookie();setCookie('landing','1049',0);" >
							...
							<input type="hidden" name="emailIdexists"	 id="emailIdexists" />			
									...
									<table width="65%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            ...
                                            <html:hidden property="refferCode"  value="1049" styleId="refferCode" /> 
