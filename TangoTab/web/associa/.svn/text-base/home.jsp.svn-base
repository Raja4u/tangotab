...
<body topmargin="0" bottommargin="0" onload="setCookie('landing','1008',0);">
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <table width="300" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td height="480" align="center" valign="top" background="../images/fb_signup_bg.png"><table width="85%" border="0" cellspacing="4" cellpadding="4">
                            ...
                            <tr>
                            <td>
							<html:hidden property="refferCode"  value="1008" styleId="refferCode" />
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" valign="middle"><a href="http://www.associacares.com/" target="_blank"><img src="images/associacares-logo.png" width="221" height="55" border="0" /></a></td>
                      </tr>
                      <tr>
