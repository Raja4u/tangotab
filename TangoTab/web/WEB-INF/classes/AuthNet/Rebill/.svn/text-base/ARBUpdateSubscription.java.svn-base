...
@XmlType(name = "", propOrder = { "merchantAuthentication", "subscriptionId", "subscription" })
@XmlRootElement(name = "ARBUpdateSubscription")
public class ARBUpdateSubscription {
	 ...
	 * 
	 * @return possible object is {@link ARBSubscriptionType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link ARBSubscriptionType }
	 * 
	 */
