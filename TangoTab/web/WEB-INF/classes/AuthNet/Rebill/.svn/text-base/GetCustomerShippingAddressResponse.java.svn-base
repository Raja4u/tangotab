...
@XmlType(name = "", propOrder = { "getCustomerShippingAddressResult" })
...
public class GetCustomerShippingAddressResponse {
	 ...
	 * 
	 * @return possible object is {@link GetCustomerShippingAddressResponseType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link GetCustomerShippingAddressResponseType }
	 * 
	 */
