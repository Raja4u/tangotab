...
public interface ServiceSoap {
	 ...
	 * 
	 * @return returns AuthNet.Rebill.ANetApiResponseType
	 */
	...
	public ANetApiResponseType authenticateTest(
			@WebParam(name = "merchantAuthentication", targetNamespace = "https://api.authorize.net/soap/v1/") MerchantAuthenticationType merchantAuthentication);
	 ...
	 * @param subscription
	 * @param merchantAuthentication
	 * @return returns AuthNet.Rebill.ARBCreateSubscriptionResponseType
	 */
	...
	public ARBCreateSubscriptionResponseType arbCreateSubscription(
			@WebParam(name = "merchantAuthentication", targetNamespace = "https://api.authorize.net/soap/v1/") MerchantAuthenticationType merchantAuthentication,
			@WebParam(name = "subscription", targetNamespace = "https://api.authorize.net/soap/v1/") ARBSubscriptionType subscription);
	 ...
	 * @return returns AuthNet.Rebill.ARBUpdateSubscriptionResponseType
	 */
	...
	public ARBUpdateSubscriptionResponseType arbUpdateSubscription(
			@WebParam(name = "merchantAuthentication", targetNamespace = "https://api.authorize.net/soap/v1/") MerchantAuthenticationType merchantAuthentication,
			@WebParam(name = "subscriptionId", targetNamespace = "https://api.authorize.net/soap/v1/") long subscriptionId,
			@WebParam(name = "subscription", targetNamespace = "https://api.authorize.net/soap/v1/") ARBSubscriptionType subscription);
	 ...
	 * @param merchantAuthentication
	 * @param subscriptionId
	 * @return returns AuthNet.Rebill.ARBCancelSubscriptionResponseType
	 */
	...
	/**
	 * This method is used to create a new customer profile along with any customer payment profiles
	 * and customer shipping addresses for the customer profile.
	 * 
	 * @param validationMode
	 * @param merchantAuthentication
	 * @param profile
	 * @return returns AuthNet.Rebill.CreateCustomerProfileResponseType
	 */
	...
	public CreateCustomerProfileResponseType createCustomerProfile(
			@WebParam(name = "merchantAuthentication", targetNamespace = "https://api.authorize.net/soap/v1/") MerchantAuthenticationType merchantAuthentication,
			@WebParam(name = "profile", targetNamespace = "https://api.authorize.net/soap/v1/") CustomerProfileType profile,
			@WebParam(name = "validationMode", targetNamespace = "https://api.authorize.net/soap/v1/") ValidationModeEnum validationMode);

	/**
	 * This method is used to create a new customer payment profile for an existing customer
	 * profile.
	 * 
	 * @param validationMode
	 ...
	 * @param merchantAuthentication
	 * @return returns AuthNet.Rebill.CreateCustomerPaymentProfileResponseType
	 */
	...
	public CreateCustomerPaymentProfileResponseType createCustomerPaymentProfile(
			@WebParam(name = "merchantAuthentication", targetNamespace = "https://api.authorize.net/soap/v1/") MerchantAuthenticationType merchantAuthentication,
			@WebParam(name = "customerProfileId", targetNamespace = "https://api.authorize.net/soap/v1/") long customerProfileId,
			@WebParam(name = "paymentProfile", targetNamespace = "https://api.authorize.net/soap/v1/") CustomerPaymentProfileType paymentProfile,
			@WebParam(name = "validationMode", targetNamespace = "https://api.authorize.net/soap/v1/") ValidationModeEnum validationMode);

	/**
	 * This method is used to create a new customer shipping address for an existing customer
	 * profile.
	 * 
	 * @param address
	 * @param customerProfileId
	 * @param merchantAuthentication
	 * @return returns AuthNet.Rebill.CreateCustomerShippingAddressResponseType
	 */
	...
	public CreateCustomerShippingAddressResponseType createCustomerShippingAddress(
			@WebParam(name = "merchantAuthentication", targetNamespace = "https://api.authorize.net/soap/v1/") MerchantAuthenticationType merchantAuthentication,
			@WebParam(name = "customerProfileId", targetNamespace = "https://api.authorize.net/soap/v1/") long customerProfileId,
			@WebParam(name = "address", targetNamespace = "https://api.authorize.net/soap/v1/") CustomerAddressType address);

	/**
	 * This method is used to retrieve an existing customer profile along with all the customer
	 * payment profiles and customer shipping addresses for the customer profile.
	 * 
	 * @param customerProfileId
	 * @param merchantAuthentication
	 * @return returns AuthNet.Rebill.GetCustomerProfileResponseType
	 */
	 ...
	 * @param customerProfileId
	 * @param merchantAuthentication
	 * @return returns AuthNet.Rebill.GetCustomerPaymentProfileResponseType
	 */
	...
	public GetCustomerPaymentProfileResponseType getCustomerPaymentProfile(
			@WebParam(name = "merchantAuthentication", targetNamespace = "https://api.authorize.net/soap/v1/") MerchantAuthenticationType merchantAuthentication,
			@WebParam(name = "customerProfileId", targetNamespace = "https://api.authorize.net/soap/v1/") long customerProfileId,
			@WebParam(name = "customerPaymentProfileId", targetNamespace = "https://api.authorize.net/soap/v1/") long customerPaymentProfileId);
	 ...
	 * @param customerProfileId
	 * @param merchantAuthentication
	 * @return returns AuthNet.Rebill.GetCustomerShippingAddressResponseType
	 */
	...
	public GetCustomerShippingAddressResponseType getCustomerShippingAddress(
			@WebParam(name = "merchantAuthentication", targetNamespace = "https://api.authorize.net/soap/v1/") MerchantAuthenticationType merchantAuthentication,
			@WebParam(name = "customerProfileId", targetNamespace = "https://api.authorize.net/soap/v1/") long customerProfileId,
			@WebParam(name = "customerAddressId", targetNamespace = "https://api.authorize.net/soap/v1/") long customerAddressId);
	 ...
	 * @param merchantAuthentication
	 * @param profile
	 * @return returns AuthNet.Rebill.UpdateCustomerProfileResponseType
	 */
	...
	public UpdateCustomerProfileResponseType updateCustomerProfile(
			@WebParam(name = "merchantAuthentication", targetNamespace = "https://api.authorize.net/soap/v1/") MerchantAuthenticationType merchantAuthentication,
			@WebParam(name = "profile", targetNamespace = "https://api.authorize.net/soap/v1/") CustomerProfileExType profile);
	 ...
	 * @param customerProfileId
	 * @param merchantAuthentication
	 * @return returns AuthNet.Rebill.UpdateCustomerPaymentProfileResponseType
	 */
	...
	public UpdateCustomerPaymentProfileResponseType updateCustomerPaymentProfile(
			@WebParam(name = "merchantAuthentication", targetNamespace = "https://api.authorize.net/soap/v1/") MerchantAuthenticationType merchantAuthentication,
			@WebParam(name = "customerProfileId", targetNamespace = "https://api.authorize.net/soap/v1/") long customerProfileId,
			@WebParam(name = "paymentProfile", targetNamespace = "https://api.authorize.net/soap/v1/") CustomerPaymentProfileExType paymentProfile,
			@WebParam(name = "validationMode", targetNamespace = "https://api.authorize.net/soap/v1/") ValidationModeEnum validationMode);
	 ...
	 * @param customerProfileId
	 * @param merchantAuthentication
	 * @return returns AuthNet.Rebill.UpdateCustomerShippingAddressResponseType
	 */
	...
	public UpdateCustomerShippingAddressResponseType updateCustomerShippingAddress(
			@WebParam(name = "merchantAuthentication", targetNamespace = "https://api.authorize.net/soap/v1/") MerchantAuthenticationType merchantAuthentication,
			@WebParam(name = "customerProfileId", targetNamespace = "https://api.authorize.net/soap/v1/") long customerProfileId,
			@WebParam(name = "address", targetNamespace = "https://api.authorize.net/soap/v1/") CustomerAddressExType address);

	/**
	 * This method is used to delete an existing customer profile along with all the customer
	 * payment profiles and customer shipping addresses for the customer profile.
	 * 
	 * @param customerProfileId
	 * @param merchantAuthentication
	 * @return returns AuthNet.Rebill.DeleteCustomerProfileResponseType
	 */
	 ...
	 * @param customerProfileId
	 * @param merchantAuthentication
	 * @return returns AuthNet.Rebill.DeleteCustomerPaymentProfileResponseType
	 */
	 ...
	 * @param customerProfileId
	 * @param merchantAuthentication
	 * @return returns AuthNet.Rebill.DeleteCustomerShippingAddressResponseType
	 */
	 ...
	 * @param merchantAuthentication
	 * @param extraOptions
	 * @return returns AuthNet.Rebill.CreateCustomerProfileTransactionResponseType
	 */
	...
	public CreateCustomerProfileTransactionResponseType createCustomerProfileTransaction(
			@WebParam(name = "merchantAuthentication", targetNamespace = "https://api.authorize.net/soap/v1/") MerchantAuthenticationType merchantAuthentication,
			@WebParam(name = "transaction", targetNamespace = "https://api.authorize.net/soap/v1/") ProfileTransactionType transaction,
			@WebParam(name = "extraOptions", targetNamespace = "https://api.authorize.net/soap/v1/") String extraOptions);

	/**
	 * This method is used to check a customer payment profile by generating a test transaction for
	 * it.
	 * 
	 * @param customerPaymentProfileId
	 ...
	 * @param merchantAuthentication
	 * @param cardCode
	 * @return returns AuthNet.Rebill.ValidateCustomerPaymentProfileResponseType
	 */
	...
	public ValidateCustomerPaymentProfileResponseType validateCustomerPaymentProfile(
			...
			@WebParam(name = "customerProfileId", targetNamespace = "https://api.authorize.net/soap/v1/") long customerProfileId,
			@WebParam(name = "customerPaymentProfileId", targetNamespace = "https://api.authorize.net/soap/v1/") long customerPaymentProfileId,
			@WebParam(name = "customerShippingAddressId", targetNamespace = "https://api.authorize.net/soap/v1/") long customerShippingAddressId,
			@WebParam(name = "cardCode", targetNamespace = "https://api.authorize.net/soap/v1/") String cardCode,
			@WebParam(name = "validationMode", targetNamespace = "https://api.authorize.net/soap/v1/") ValidationModeEnum validationMode);
	 ...
	 * 
	 * @param merchantAuthentication
	 * @return returns AuthNet.Rebill.GetCustomerProfileIdsResponseType
	 */
