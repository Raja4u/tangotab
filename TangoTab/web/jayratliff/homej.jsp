...
<div id="wrap"> 
	...
	<table width="967" border="0" cellpadding="0" cellspacing="0">
      <tr align="center">
        <td height="495" valign="top" background="images/bg1.jpg">
...
<script type="IN/Share"></script>
            ...
            <img src="images/bg2.jpg" width="967" height="299" border="0" usemap="#Map"> </td>
          </tr>
    </table>
  <!------------------------------ START FOOTER ------------------------------>
	</form>
	...
	<!-- <div class="navjay" >
		...
		<ul>
			...
			<li><a href="http://www.tangotab.com/jsp/terms.jsp">Terms</a> </li> 
			<li><a href="http://www.tangotab.com/jsp/privacy_policy.jsp">Privacy</a> </li>
			<li><a href="http://www.tangotab.com/jsp/support_us.jsp">Support</a></li>  
				<li><a href="http://www.tangotab.com/jsp/contact_us.jsp">Contact Us</a></li>
				<li><a href="http://www.tangotab.com/jsp/jobs.jsp" >Jobs</a></li>  
				<li><a href="http://www.tangotab.com/jsp/press.jsp">Press</a></li>
				<li><a href="http://www.tangotab.com/jsp/affiliates.jsp">Affiliates</a></li>
				<li><a href="http://www.tangotab.com/jsp/aboutus.jsp">About Us</a></li>
				
				<li ><a href="#">Restaurants</a>

						<ul style="border: 2px;border-color: maroon;float: left;top:-130px!important;">
		...
		<br/>
		<ul>
		<li>Copyright © 2000-2011 TangoTab.com All rights reserved.</li>
		</ul>
...
<map name="Map"><area shape="rect" coords="387,116,582,158" href="http://www.tangotab.com/jsp/chairty.jsp"><area shape="rect" coords="828,17,896,72" href="signup.jsp"></map>
</body>
