...
<div id="wrap"> 
	...
	<tr>
		...
		<td width="300" valign="top" align="center">
			...
			<br>
			<br>			<img src="images/refferfriend.gif" width="287" height="242"><br><br><br>
            <!--
	    <a href="#"><img src="images/suppoting_minnies2.jpg" width="194" height="229" border="0"></a>--></td>
			...
			<tr>
				<td width="667" align="center" valign="top" class="title3">
					...
					<div class="title_green">
					  <p>Connect your friends, family  and colleagues with TangoTab, and increase the amount of funds raised for to feed the hungry.</p>
				  </div>
