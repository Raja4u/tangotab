                ...
                <tbody>
                  ...
                  <td align="left" valign="middle" scope="row" width="40%"><table width="60%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                      ...
                      <tr>
                        <td width="30%" align="center" valign="top" scope="row"><a href="http://www.facebook.com/TangoTab" target="_blank"><img src="<fmt:message key='website.home'></fmt:message>images/facebook_img.png" width="70" height="69" border="0"></a></td>
                        <td width="30%" align="center" valign="top" scope="row"><a href="https://twitter.com/#!/TangoTab" target="_blank"><img src="<fmt:message key='website.home'></fmt:message>images/twitter_img.png" width="70" height="69" border="0"></a></td>
