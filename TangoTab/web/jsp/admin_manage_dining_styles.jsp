<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.tangotab.dao.pojo.DiningStyle"%>
...
List<DiningStyle> dining=com.tangotab.businessImpl.BusinessFactory.getBillingMethodsBO().getDiningStyles();
		...
		<div class="cantainer_inner">
			<div class="main_cantainer">
			    ...
			    <tr>
			        ...
			        <html:form action="/jsp/diningStylesdisplay" method="post">
						<!-- form Start-->
              ...
              <tr>
                ...
                <td width="952" height="100" align="center" valign="top"><table width="935" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30" align="center" valign="middle" class="red_max">  Manage Dining Styles</td>
                  </tr>
                  ...
                  <tr>
                   ...
                   <tr>
                            <td height="24" align="center" valign="middle" class="text_h3">Dining Styles</td>
                            <td align="center" valign="middle" class="text_h3">Status</td>
                          </tr> <% int active=0;
                          Iterator it=dining.iterator();
                    while(it.hasNext())
                   {
                   diningStyle=(DiningStyle)it.next();
                   
                   %>
                          <tr>
                            <td align="left" valign="middle" class="table_dark">
                            <html:hidden property="diningStyleId" value="<%=Integer.toString(diningStyle.getDiningStyleId()) %>" />
                            <html:hidden property="diningStyleName" value="<%=diningStyle.getDiningStyleName() %>" />
                            <a href="diningStylesdisplay.do?operation=insert&id=<%=diningStyle.getDiningStyleId() %>" class="bla_low"><u><%=diningStyle.getDiningStyleName() %></u></a></td>
                            <td align="left" valign="middle" class="table_dark"> 
                           <select name="isActive">
                           <option value="1"  <% if(diningStyle.getIsActive()==1) out.print("selected='selected';"); %>>Active</option>
                           <option value="0" <% if(diningStyle.getIsActive()==0) out.print("selected='selected';"); %>  >InActive</option>
                           </select>
                            </td>
                          </tr>
                        ...
                        <!--  <tr>
                          ...
                          <tr>
                            <td height="30" align="right" valign="middle" class="table_light"><table width="75" border="0" align="right" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="center" valign="middle"><div class="login_butgre"><a href="diningStylesdisplay.do?operation=insert&type=new">New</a></div></td>
                              </tr>
                            </table></td>
