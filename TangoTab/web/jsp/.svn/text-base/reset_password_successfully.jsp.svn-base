												...
												<table width="100%" border="0" cellspacing="0"
													...
													<tr>
														<td height="75" align="center" valign="top">
															<strong class="red_max">Password has been reset successfully.</strong>
														</td>
													</tr>
													<c:if test="${userInfo.roleId eq 4 }">	
													<tr>
														<td height="75" align="center" valign="top" style="bbut_img_mx" >
														  <div id="select_hot_max" >
															<a href="searchForward.do" style="text-decoration:none; width:400; font-size: 13px; color: #000000;">Search for offers in your city</a></div>
														</td>
													</tr>
													</c:if>
