...
//	alert(document.getElementById("restLocationId").options[document.getElementById("restLocationId").selectedIndex].value);
		...
		document.frm.action = "AdminCreateDeal.do?operation=viewDeals&restid="+${restId}+"&locationId="+locationId;
		document.frm.submit();
	}
              ...
              <tr>
                ...
                <table width="945" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td height="35" align="center" valign="middle" class="red_max">View Deals</td>
                  </tr>
                   <logic:messagesPresent message="true">
											<html:messages id="message" message="true">
												<logic:present name="message">
													<tr>
														<td align="center" valign="middle" colspan="2" class="red_text"  >
                  ...
                  <c:if test="${(userInfo.roleId eq 1 or userInfo.roleId eq 6) and locationsInfoSize gt 1 }"> 
                  <tr>
                  <td align="left">
                            ...
                            <table width="950" border="0" align="center" cellpadding="0" cellspacing="5">
                              ...
                              <c:if test="${deal.restDealPublishStatus == 0}">
                              		<c:if test="${userInfo.billingMethodId == 1}">
                              			<c:if test="${userInfo.currentCredits > 0}">
		                                	<td align="right" valign="top"><table align="left" cellpadding="0" cellspacing="0"><tr><td align="left" class="login_butgre">
		                                 	<a href="AdminCreateDeal.do?operation=viewDeals&restid=${restId}&dealId=${deal.dealTemplateId}&&type=publish " class="login_butgre">Publish</a></td></tr></table></td>
	                                 	</c:if>
                                 ...
                                 <c:if test="${deal.restDealPublishStatus == 1}">
                                  	 <td align="right" valign="top"><table align="left" cellpadding="0" cellspacing="0"><tr><td align="left" class="login_butgre">
                                  	 <a href="AdminCreateDeal.do?operation=viewDeals&restid=${restId}&dealId=${deal.dealTemplateId}&&type=unpublish " class="login_butgre">Unpublish</a></td></tr></table></td>
                                  </c:if>
                                <td align="right" valign="top">
                                <table align="left" cellpadding="0" cellspacing="0"><tr><td align="left" class="login_butgre">
                                <a href="admineditDeal.do?dealId=${deal.dealTemplateId}&viewdeal=yes&restId=${restId}" >Edit</a></td></tr></table>
                                </td>
