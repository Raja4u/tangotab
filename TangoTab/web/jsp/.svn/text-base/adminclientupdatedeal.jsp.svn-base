...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	if(document.dealRegForm.startDate.value!='' && document.dealRegForm.dealEndDate.value!='')
	{
	 ...
	 var index1=0;
		...
		document.getElementById("todatemsg").innerHTML="Please Select of after start date.";
	 		return false;
		}else 
		{
...
<div class="cantainer_inner">
			<div class="main_cantainer">
          	...
          	<!-- form Start--><html:form action="/jsp/admindealUpdate"  onsubmit="return check();"  enctype="multipart/form-data">
                            	<input type="hidden" name="viewpage" id="viewpage" value="${viewdeal}"/>
                            	<table width="968" border="0" cellspacing="0" cellpadding="0">
									<tr>
				                ...
				                <html:hidden property="customDeal" value="${dealInfo.customDeal}"/>
								 ...
								 <html:hidden property="restaurantId" value="${restId}" />
											...
											<table width="945" border="0" align="center" cellpadding="0"
												...
												<tr>
													...
													<td colspan="2" align="left" valign="middle" class="text_h9">
														...
														<html:textarea property="dealTemplateName" value="${dealInfo.dealTemplateName}" styleClass="restaurant_input" name="dealInfo" />
														...
														<span id="dealnamemsg" class="red_text"><html:errors property="dealTemplateName" />
														  </span>
													</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<span id="dealrestmsg" class="red_text"><html:errors property="dealTemplateRestrictions" />	 </span>	 </span>
													</td>
												</tr>
												<tr>
												...
												<tr>
													...
													<td align="left" valign="middle" class="text_h9"><html:hidden property="usedDealsQty"   value="${dealInfo.usedDealsQty}"/>
												...
												<html:errors property="availableDealsQty" />
 
 												<input type="hidden" name="dealId" value="16" /></td>
                                                 <td width="200" height="100" rowspan="4" align="center" valign="top" class="text_h9"><img src="${dealInfo.restDealImagePath}" width="188" height="196"/></td>
												</tr>
												<tr>
													<td align="right" valign="middle" class="bla_low">
														Recurring
	...
	<tr>
													<td rowspan="2" align="right" valign="middle" class="bla_low">
														Image Upload:							</td>
														...
														<table width="330" border="0" align="center"
															...
															<tr>
																...
																<td colspan="2" align="left">
																	...
																	<c:if test="${not empty viewdeal and viewdeal eq 'yes'}">
																		<a href="AdminCreateDeal.do?operation=display&viewDeals=yes">Cancel</a>	
																	</c:if>
																	<c:if test="${empty viewdeal}">
