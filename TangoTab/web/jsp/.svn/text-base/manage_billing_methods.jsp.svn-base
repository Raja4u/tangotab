...
<%@page import="com.tangotab.dao.pojo.BillingMethod"%>
...
<%! List<BillingMethod> billing = new ArrayList<BillingMethod>(); %>
<%
 billing = (List<BillingMethod>)request.getAttribute("billingMethodList");
 if(billing == null )
  billing = (List<BillingMethod>)session.getAttribute("billingMethodList");
		...
		<div class="cantainer_inner">
			...
			<table width="760" border="0" cellspacing="0" cellpadding="0">			  
			    ...
			    <tr>
			        ...
			        <html:form action="/jsp/billingMethodsdisplay" method="post">
						<!-- form Start-->
              ...
              <tr>
                ...
                <td width="952" height="100" align="center" valign="top"><table width="935" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30" align="center" valign="middle" class="red_max">  Manage Billing Methods</td>
                  </tr>
                  ...
                  <tr>
                   ...
                   <tr>
                            <td height="24" align="center" valign="middle" class="text_h3">Billing Method</td>
                            <td align="center" valign="middle" class="text_h3">Status</td>
                          </tr> <% int active=0;
                          Iterator it=billing.iterator();
                    while(it.hasNext())
                   {
                   billingMethod=(BillingMethod)it.next();
                   
                   %>
                          <tr>
                            <td align="left" valign="middle" class="table_dark">
                            <html:hidden property="billingMethodId" value="<%=Integer.toString(billingMethod.getBillingMethodId()) %>" />
                            <html:hidden property="billingMethodName" value="<%=billingMethod.getBillingMethodName() %>" />
                            <a href="billingMethodsdisplay.do?operation=insert&id=<%=billingMethod.getBillingMethodId() %>" class="bla_low"><u><%=billingMethod.getBillingMethodName() %></u></a></td>
                            <td align="left" valign="middle" class="table_dark"> 
                           <select name="isActive">
                           <option value="1"  <% if(billingMethod.getIsActive()==1) out.print("selected='selected';"); %>>Active</option>
                           <option value="0" <% if(billingMethod.getIsActive()==0) out.print("selected='selected';"); %>  >InActive</option>
                           </select>
                            </td>
                          </tr>
                        ...
                        <!--  <tr>
                          ...
                          <tr>
                            <td height="30" align="right" valign="middle" class="table_light"><table width="75" border="0" align="right" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="center" valign="middle"><div class="login_butgre"><a href="billingMethodsdisplay.do?operation=insert&type=new">New</a></div></td>
                              </tr>
                            </table></td>
