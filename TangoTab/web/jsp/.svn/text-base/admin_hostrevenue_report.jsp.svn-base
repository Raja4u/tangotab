...
function check()
      {
       var error = false;
       var getall = document.getElementById("getYes").checked;
       /* if admin wants all then no validation needed */
      if(getall == false){
...
<body onload="document.getElementById('getNo').checked = true;">
<div id="wrapper">
		<div id="main">
<!--Header Start-->
    ...
    <table width="968" border="0" cellspacing="0" cellpadding="0">
      <%@ include file="admin_banner.jsp" %>     
       <tr>
        ...
        <html:form action="/jsp/revenueReport" method="post" onsubmit="return check();">
            <table width="968" border="0" cellspacing="0" cellpadding="0">
              <tr>
              ...
              <tr>
                ...
                <td height="100" align="center" valign="top"><table width="945" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30" align="center" valign="middle" class="red_max">Download Restaurant Revenue Report </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <tr> 
                    <td align="right" valign="middle" colspan="3"> <span class="gre_low">Do you want the whole report: </span>
                    </td>
                    <td align="left" valign="middle"> 
                    <html:radio property="getAll" styleId = "getYes" value="Yes" styleClass="bla_low"> <span class="bla_low"> Yes </span></html:radio>    
                    <html:radio property="getAll" value="No" styleId = "getNo" styleClass="bla_low" ><span class="bla_low"> No </span> </html:radio>      	
                    </td>
                    </tr>
                    
                    <tr>
                    <td height="45" width="50" align="right" valign="middle" class="text_formsub">
                    ...
                    <td width="50" align="right" valign="middle" class="gre_low">End Date:</td>
                    <td width="150" align="left" valign="middle">
                    ...
                    <td width="50" align="right" valign="middle"><table width="70" border="0" align="left" cellpadding="0" cellspacing="0">
                        <tr>
           
                         <td><div id="select_hot"><html:submit    styleId="download" styleClass="login_butgre">Download</html:submit></div></td>
                        </tr>
                    </table></td>
                  </tr>
                    </table></td>
