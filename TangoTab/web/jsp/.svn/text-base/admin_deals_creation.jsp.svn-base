		   ...
		   /* var cname = document.getElementById("customDealId").value;
			...
			if(document.getElementById("customDealId").value==null || document.getElementById("customDealId").value.trim()==""){
				...
				err = true;
				 ...
				 document.getElementById("dealNameIDmsg").innerHTML="Deal Name  length  can't be greater than 500";
				 ...
				 if(document.getElementById("custdealdesc").value!=null && document.getElementById("custdealdesc").value.trim()!=""  && (document.getElementById("custdealdesc").value).length>1000){
				  document.getElementById("custdealdescmsg").innerHTML="Deal Description length  can't be greater than 1000";
				 }
				 err = true;
			}
			if(document.getElementById("custdealdesc").value==null || document.getElementById("custdealdesc").value.trim()==""){
...
/* For normal deals  */
	...
	if(document.getElementById("dealNameId").value!= null && document.getElementById("dealNameId").value.trim()!= "" && (document.getElementById("dealNameId").value).length>500 ){
       document.getElementById("dealNameIDmsg").innerHTML="Deal Name  length  can't be greater than 500";
       err = true;
       }
     if(document.getElementById("dealTemplateDescription").value!= null && document.getElementById("dealTemplateDescription").value.trim()!= "" && (document.getElementById("dealTemplateDescription").value).length>1000 ){
       document.getElementById("custdealdescmsg").innerHTML="Deal Description  length  can't be greater than 1000";
       err = true;
      }
    if(document.getElementById("dealTemplateRestrictions").value!= null && document.getElementById("dealTemplateRestrictions").value.trim()!= "" && (document.getElementById("dealTemplateRestrictions").value).length>1000 ){
       document.getElementById("dealRetId1").innerHTML="Deal Restriction  length  can't be greater than 1000";
       err = true;
       }
	/*if(document.getElementById("fileField").value==null || document.getElementById("fileField").value==""){
	   ...
	   if( document.getElementById("dealImage").value==null || document.getElementById("dealImage").value=="" ){
			  document.getElementById("dealImagemsg").innerHTML="Custom Offer Image required";
			  err = true;
			}
...
document.getElementById("totimemsg").innerHTML="";
 ...
 //currentDate.setDate()
  ...
  //alert(endDate);
		...
		document.getElementById("todatemsg").innerHTML="Please Select TO date must be after From date";
	 		return false;
		} 		
	...
	var deal = document.getElementById("dealNameId").value;
		...
		var val= document.getElementById("customDealId").value;
			if(document.getElementById("customDealId").value==null || document.getElementById("customDealId").value==""){
				...
				document.getElementById("dealImagemsg").innerHTML="Deal Image or Custom Deal Image required";
				...
				document.getElementById("custdealdescmsg").innerHTML="Deal Description required";
				 return false;
				} else if(document.getElementById("custdealdesc").value!=null && document.getElementById("custdealdesc").value!=""  && (document.getElementById("custdealdesc").value).length>1000){
				document.getElementById("custdealdescmsg").innerHTML="Deal Description length  can't be greater than 1000";
				 return false;
				} 
				if(document.getElementById("fileField").value=="" && document.getElementById("dealImage").value==""){
					...
					<table width="968" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td height="17" colspan="3" align="center" valign="top">
								<!-- form Start-->
									<html:form action="/jsp/AdmindealReg"  enctype="multipart/form-data" onsubmit="return check();">
										...
										<td height="100" align="center" valign="top">
											<table width="952" border="0" align="center" cellpadding="0"
														...
														<html:select property="restLocationId" 
															...
															<html:option value="0">----ALL----</html:option>
															 ...
															 <c:forEach items="${location}" var="location">
																 <c:if test="${location.isActive eq 1 }" >
												...
												<tr>
													...
													<td colspan="2" align="left" valign="middle" class="text_h9">
														<table align="left" border="0" cellpadding="0" cellspacing="0">
															<tr>
																<td align="left" >
													   <html:textarea property="dealTemplateName"  
																		styleClass="restaurant_select"  styleId="dealNameId"/>
																														
												
														 														</td>
																<td id="dealNameIDmsg" class="red_text" align="left">
																	<html:errors property="dealTemplateName"/>																</td>
																<td  width="160" id="textDealId">
																	<html:text property="customDealTemplateName" styleId="customDealId"   style="display:none"></html:text>																</td>
												...
												<span class="text_h9"  id="dealDesc" style="float:left;">
												   ...
												   <html:textarea property="dealTemplateDescription" styleId="dealTemplateDescription" styleClass="restaurant_select"  />
																</span>
																<span class="text_h9"  id="dealDesccust" style="display:none;float:left;" >																	
																	<html:text property="custdealdesc"  styleId="custdealdesc" />	
																</span>									 
													...
													<div id="dealRetId">
														...
														<bean:define id="relationships4" name="dropDownList"
															...
															<c:forEach var="dealr" items="${dropDownList.dealRestriction}">
																...
																<span class="text_h9"   style="float:left;" >
														<html:textarea cols="20" rows="5" styleId="dealTemplateRestrictions" property="dealTemplateRestrictions" onkeypress="return acceptData(event,this.value);" onkeyup="showCount(this.value);"/>
													</span>
												...
												<tr>
			                                      ...
			                                      <td colspan="2" align="center" valign="middle" class="text_h10">
			                                       <div id="imageuploadN" style="display: block;">[NOTE:*An image size of 190(width) x 130(height) pixels is recommended.*]
											    			...
											    			<tr>
													<td align="right" valign="middle" class="bla_low">
												  <div id="imageupload" style="display: block;">Upload Host Image:</div>
													<br /></td>
													<td align="left" valign="middle" class="text_h9">
													...
													<div id="submitone">
														<table width="440" border="0" align="center"
															...
															<td align="center" valign="middle" width="110">
																	<div id="select_hot" align="center">
																		<a href="dealPending.do">Cancel</a>	
																	</div>	
 																</td>
 																<!--<td align="center" valign="middle" width="110">
																	<div id="select_hot" align="center">
