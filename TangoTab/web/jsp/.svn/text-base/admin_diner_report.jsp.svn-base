    ...
    <table width="968" border="0" cellspacing="0" cellpadding="0">
      <%@ include file="admin_banner.jsp" %>     
       <tr>
        ...
        <html:form action="/jsp/guestReport" method="post" onsubmit="return check();">
            <table width="968" border="0" cellspacing="0" cellpadding="0">
              <tr>
              ...
              <tr>
                ...
                <td height="100" align="center" valign="top"><table width="945" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30" align="center" valign="middle" class="red_max">Download Diner Report </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <tr> 
                    <td align="right" valign="middle" colspan="3"> <span class="gre_low">Do you want all diners in the report: </span>
                    </td>
