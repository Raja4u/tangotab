<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.tangotab.dao.pojo.RestaurantLocation"%>
            ...
            <table width="968" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td height="100" align="center" valign="top"><table width="945" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30" align="center" valign="middle" class="red_max">Restaurant Location Management</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td align="center" valign="top"  class="blue_medium"><br/>
                          ...
                          <%
						   ArrayList<RestaurantLocation> list=(ArrayList)request.getAttribute("restList");
						     int i=0;
						     String style="";
						     RestaurantLocation restaurantLocation=new RestaurantLocation();
						     %>
						   
                              <display:table requestURI='restaurantlocations.do' id="restList" name="restList" pagesize="20"  cellpadding="3" cellspacing="3"  style="background-color:#cccccc;width:78%">
									 <%
                                i++;
                                style="table_light"; 
                                if(i%2==0)
							  ...
							  <display:column  headerClass="text_h3"  title="Sl.No"   class="<%=style%>" style="width:5%;">
                               ...
                               <display:column   class="<%=style%>" headerClass="text_h3"    style="width:25%;"  title="Location Name" >
                               <a href="restaurantmanage.do?restid=<bean:write name="restList"  property="restLocationId"/>">
                               <bean:write name="restList"  property="locationRestName"/></a>
                               </display:column>
                               <display:column   class="<%=style%>" headerClass="text_h3" style="width:25%;" title="City" >
                               <bean:write name="restList"  property="cityId"/>
                               
                               </display:column>
                                 <display:column   class="<%=style%>" headerClass="text_h3" style="width:25%;" title="Zip/Post Code" >
                              <bean:write name="restList"  property="zipCode"/>
                               
                               </display:column>
                               
                                    <display:column   class="<%=style%>" headerClass="text_h3" style="width:25%;" title="Status" >
                                   <% restaurantLocation=(RestaurantLocation)list.get(i-1);
                                   %>  
                               <html:select property="isActive"  value="<%= Integer.toString(restaurantLocation.getIsActive()) %>">
                               <html:option value="1">Active</html:option>
                                <html:option value="0">Pending</html:option>
                                 <html:option value="2">Suspended</html:option>
