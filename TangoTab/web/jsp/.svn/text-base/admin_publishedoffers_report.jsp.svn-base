    ...
    <table width="968" border="0" cellspacing="0" cellpadding="0">
      <%@ include file="admin_banner.jsp" %>     
       <tr>
        ...
        <html:form action="/jsp/publishedOffersReport" method="post" onsubmit="return check();">
            <table width="968" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td height="100" align="center" valign="top"><table width="945" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <table width="945" border="0" align="center" cellpadding="0" cellspacing="5">
                      <tr>
                       <td height="40" width="50" align="right" valign="middle" class="text_formsub">
                     <span class="gre_low">Select City </span>:</td>
                     <td width="150"><html:select property="cityId" 
															styleClass="restaurant_select" styleId="cityId" value="${city.cityName}">
															<html:option  value="">All</html:option>
															<c:forEach var="city" items="${dropDownList.cities}">
