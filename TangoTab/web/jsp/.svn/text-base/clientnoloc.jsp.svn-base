				        ...
				        <td height="17" colspan="3" align="center" valign="top"><!-- form Start-->
				            <table width="968" border="0" cellspacing="0" cellpadding="0">
				              ...
				              <tr>
				                ...
				                <td width="952" height="222"  valign="top"  id="select_hot"><br/>
				                <c:if test="${ empty locationsInfo }" >
				                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
				                    <tr>
				                      <td colspan="3" height="75" align="center" valign="top" id="select_hot">
				                      <strong class="red_max">You must first add a location before you can create deals. </strong>
				                     	
				                      </td>  
				                    </tr>
				                    <tr>
				                        <td width="44%"></td>
				                        <td width="12%" height="75" align="left" valign="top">
				                        <a href="locationinformation.jsp">Add Location</a>
				                        </td>
				                        <td width="44%"></td>
				                    </tr>
				                  ...
				                  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
				                    <tr>
				                      <td colspan="3" height="75" align="center" valign="top" id="select_hot">
				                      <strong class="red_max">Your location is suspended .  </strong>
