...
if(value == "Yes") {
	...
	document.getElementById("emailIds").style.display ="none";
	document.locationForm.emailId.value = '${rest.user.emailId}';
	document.locationForm.firstname.value = '${rest.user.firstname}';
	document.locationForm.mobilePhone.value = '${rest.user.mobilePhone}';
...
<script type="text/javascript">
  ...
  if(document.locationForm.adddo.checked==true)
 {
		    ...
		    document.locationForm.address.value='${rest.user.address}';
		    document.locationForm.address1.value='${rest.user.address1}';
		 document.locationForm.cityId.value='${rest.user.cityId}';
		    document.locationForm.stateId.value='${rest.user.stateId}';
		    	 document.locationForm.zipCode.value='${rest.user.zipCode}';
		    document.locationForm.countryId.value='${rest.user.countryId}';
      ...
      <%@ include file="admin_banner.jsp" %>     
       <tr>
        <td height="17" colspan="3" align="center" valign="top">
			        <html:form action="/jsp/savelocation.do?operation=save" method="post"
			...
			<!-- form Start-->
			                ...
			                <td width="952" height="100" align="center" valign="top"><table width="930" border="0" align="center" cellpadding="0" cellspacing="5">
			                  ...
			                  <tr>
			                   ...
			                   <td align="right" valign="middle" class="bla_low">Business Name<span class="red_text">*</span>:</td>
			                    <td align="left" valign="middle"><html:text property="businessName" onkeyup="hidetext('businessName')"  styleClass="restaurant_input" value="${businessname}" readonly="true"></html:text>
                                <html:errors property="businessName"/></td>
			                  
			                  </tr>
			                  <tr>
			                    <td align="right" valign="middle" class="bla_low">Restaurant Image:</td>
                    ...
                    &nbsp;Location address  is same as Business address</td>
			                  ...
			                  <tr>
			                   ...
			                   <tr>
			                    ...
			                    <td align="left" valign="middle"><html:text property="address1"   styleClass="restaurant_input"></html:text>
									 <span  class="red_text" id="address"></span>
									 </td>
			                  </tr>
			                  <tr> 
			                  ...
			                  <tr>
			                    ...
			                    <td align="left" valign="middle">
										<html:select property="stateId"  styleClass="restaurant_select" styleId="states"  value="${user.stateId}" >
			                    	...
			                    	<table width="100%" border="0" cellspacing="0" cellpadding="0">
									     <tr>
									         <td width="163" align="left" valign="top">
										             	<html:text property="emailId"	styleClass="restaurant_input" styleId="emailId" onkeyup="hidetext('checkEmailId')"  onblur="checkEmail(6)"></html:text> 
							...
							<span  class="red_text" id="firstname"><html:errors property="firstname"/> </span></td>
			                  ...
			                  <tr>
			                    <td align="right" valign="middle" class="bla_low">Web site :</td>
			                  ...
			                  <!--<tr> 
			                    <td align="right" valign="top" class="bla_low">Direction Image:<span class="red_text">*</span>:</td>
			                    <td align="left" valign="middle">	<html:file property="directionImage" />
							    <span  class="red_text" id="directionImgPath"><html:errors property="directionImgPath"/></span></td>
			                  </tr>
			                  --><tr> 
			                  <td align="right" valign="top" class="bla_low">Ratings:<span class="red_text">*</span>:</td>
			                   <td align="left" valign="middle">
			                   <html:text property="rating" />
							<span  class="red_text" id="rating"><html:errors property="rating"/></span></td>
			                  </tr>
			                  <!-- <tr>
			                    ...
			                    <td align="left" valign="top" class="text_h9"> <html:errors property="diningStylePreferences"/><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
			                        <c:if test="${not empty dropDownList.diningStyles}">
																	<c:forEach var="cusineType" items="${dropDownList.diningStyles}" varStatus="status">
																		...
																		<td align="left" valign="middle">
																			<html:radio property="diningStylePreferences" value="${cusineType.diningStyleId}"/>${cusineType.diningStyleName} 
																		</td>
																	   ...
																	   <c:set var="flag" value="notok" ></c:set>
																		...
																		<td align="left" valign="middle">
			                        		                         	...
			                        		                         	<c:if test="${cusineType.cuisineTypeId eq pList}">
																			...
																			<input type="checkbox" name="preferencesList"  checked="true"   onclick="hidetext('preferencesList')"  value="${cusineType.cuisineTypeId}"/>${cusineType.type}
																			</c:if> 
																							<c:if test="${flag eq 'notok'}">
									  
																			<html:checkbox property="preferencesList"   onclick="hidetext('preferencesList')"  value="${cusineType.cuisineTypeId}"/>${cusineType.type}
																			</c:if> 
			                  ...
			                  <tr>
			                    <td height="40" colspan="2" align="center" valign="middle"><table width="330" border="0" align="center" cellpadding="0" cellspacing="0">
			                        <tr>
			                        <td><div id="select_hot"><a href="viewlocationMgmt.do?operation=display">Cancel</a></div></td>
									<td><div id="select_hot"><a href="newlocation.do?operation=insert&restid=${restid}&businessName=${locationEditForm.businessName}">Reset</a></div></td>
