		...
		<div class="cantainer_inner">
			<div class="main_cantainer">
			    ...
			    <table width="968" border="0" cellspacing="0" cellpadding="0">
			      ...
			      <tr>
			        <td height="222" colspan="3" align="center" valign="top"><table width="968" border="0" cellspacing="0" cellpadding="0">
			          <tr>
			          ...
			          <tr>
			            ...
			            <td height="100" align="center" valign="top"><br/>
			                <table width="100%" border="0" cellspacing="0" cellpadding="0">
			                  <tr>
			                    <td height="150" align="center" valign="middle"><span class="red_max"><strong>Thank you for registering  with TangoTab. Please check your email and complete the validation process.</strong></span></td>
			                  </tr>
			                  <tr>
