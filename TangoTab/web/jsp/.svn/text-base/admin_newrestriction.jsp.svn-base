                ...
                <td width="952" height="100" align="center" valign="top"><table width="935" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td align="center" valign="top"><br/> 
                            ...
                            <html:form action="/jsp/saveRestriction">      
         		<table width="60%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#cccccc">
                      <tr>
                        <td align="right" valign="middle" class="table_light">Deal Restriction<span class="red_text">*</span>:</td>
                        <td align="left" valign="middle" class="table_light"><span class="red_text">
                          <html:textarea property="restriction" styleClass="restaurant_input"  /> 
                         <span class="red_text" id="restriction"><html:errors property="restriction"></html:errors></span>
                          <html:hidden property="restrictionId" styleClass="restaurant_input"  />
                          <html:hidden property="isActive" styleClass="restaurant_input" />
                       </span></td>
                      </tr>
                      <tr>
