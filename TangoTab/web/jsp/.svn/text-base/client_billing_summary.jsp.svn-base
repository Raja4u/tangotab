              ...
              <tr>
                ...
                <table width="940" border="0" align="center" cellpadding="0" cellspacing="5">
                  ...
                  <tr>
                    ...
                    <td align="left" valign="middle"><table width="110" border="0" align="left" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <html:submit styleClass="but_img" property="submit" styleId="submitID">Search</html:submit></div></td>
                        </tr>
                    </table></td>
                  </tr>
                    </table></td>
                  ...
                  <tr>
                    ...
                    <td align="center" valign="top">
                    <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr> <td align="left" valign="middle" class="text_h3" align="center">
                          Current Auto Debit Status :-   <c:if test="${userInfo.restaurent.isAutoDebit eq 1}"> Yes</c:if>
                           <c:if test="${userInfo.restaurent.isAutoDebit ne 1}"> No</c:if></td>
                        </tr>
                    </table></td>
                  </tr>
                        ...
                        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
                          <tr>
                            ...
                            <td align="center" valign="middle" class="text_h3">Transaction Number</td>
                              <td align="center" valign="middle" class="text_h3">Card Number</td>
