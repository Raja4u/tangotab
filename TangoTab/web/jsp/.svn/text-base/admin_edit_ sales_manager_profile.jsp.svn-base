...
<link href="../css/tangotab.css" rel="stylesheet" type="text/css" />
       ...
       <script language="javascript" type="text/javascript">
       		...
       		function selectAllCities(){
				 ...
				 document.forms[0].action = "salesUpdate.do?type=manager";
  ...
  <body >
	...
	<div id="wrap"><jsp:include page="header.jsp">
		...
		<html:hidden property="userId" name="mgrInfo"/>
		<html:hidden property="salesInfoId" name="mgrInfo"/>
		<html:hidden property="salasMgrUserId" name="mgrInfo"/>
		<div class="content">
			<div class="insight-content"><div class="mid_consumer">
			<html:form action="/jsp/salesUpdate">
			<table width="760" border="0" cellspacing="0" cellpadding="0">			  
              ...
              <tr>
                ...
                <td width="952" height="100" align="center" valign="top"><table width="938" border="0" cellpadding="0" cellspacing="5">
                  <tr>
                    <td height="40" colspan="2" align="center" valign="middle" class="red_max">Sales Manager Update</td>
                    </tr>
                  <tr>
                    <td align="right" valign="middle" class="bla_low">First Name:</td>
                    <td width="38%" align="left" valign="middle"><span class="red_text">
                      <html:text  property="firstname" styleClass="restaurant_input"  name="mgrInfo"/>
                    </span></td>
                  </tr>
                  <tr>
                    <td width="22%" align="right" valign="middle" class="bla_low">Last Name:</td>
                    <td width="38%" align="left" valign="middle"><span class="red_text">
                      <html:text  property="lastname"  styleClass="restaurant_input"  name="mgrInfo"/>
                    </span></td>
                  </tr>
                  <tr>
                    <td align="right" valign="top" class="bla_low">Home Address:</td>
                    <td align="left" valign="middle"><html:textarea   property="address" name="mgrInfo" styleClass="restaurant_textarea"></html:textarea></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="bla_low">Home Phone:</td>
                    <td align="left" valign="middle"><span class="red_text">
                      <html:text  property="homePhone"  styleClass="restaurant_input"  name="mgrInfo"/>
                    </span></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="bla_low">Mobile Number:</td>
                    <td align="left" valign="middle"><span class="red_text">
                      <html:text  property="mobilePhone"  styleClass="restaurant_input"  name="mgrInfo"/>
                    </span></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="bla_low"> Email ID:</td>
                    <td align="left" valign="middle"><span class="red_text">
                      <html:text  property="emailId"  styleClass="restaurant_input" name="mgrInfo"/>
                    </span></td>
                  </tr>
                  <tr>
                    <td align="right" valign="middle" class="bla_low">Hire Date:</td>
                    <td align="left" valign="middle" class="text_h9">
					<html:text  property="hireDate" styleId="hireDate" name="mgrInfo"/><html:hidden property="salesManId" value="${mgrInfo.salesManId}"/>
                  ...
                  <tr>
                    ...
                    <td align="left" valign="middle" class="text_h9">
                      <html:text property="terminationDate"  styleId="terminationDate" styleClass="restaurant_input" name="mgrInfo"/>
                                ...
                                <tr>
                                  <td height="155" colspan="6" align="center" valign="top" class="list_menu">
                                 		 <html:select property="cities" size="10" multiple="true" styleClass="list_menu" styleId="cities">
                                   			<c:if test="${not empty mgrInfo.citiesInfo}">
	                                   			<c:forEach var="city" items="${mgrInfo.citiesInfo}" varStatus="count">
