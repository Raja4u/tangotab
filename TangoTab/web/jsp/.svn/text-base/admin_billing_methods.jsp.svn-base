...
<%@ taglib uri="/WEB-INF/struts-logic.tld" prefix="logic"%>
 ...
 {
 addtype=request.getParameter("type");
 } %>
                ...
                <td width="952" height="100" align="center" valign="top"><table width="935" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td align="center" valign="top"><br/> 
                            ...
                            <html:form action='/jsp/billingMethods'>      
         		<table width="60%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#cccccc">
                      <tr>
                        <td align="right" valign="middle" class="table_light">Billing Method<span class="red_text">*</span>:</td>
                        <td align="left" valign="middle" class="table_light"><span class="red_text">
                          <html:text property="billingMethodName" styleClass="restaurant_input"  /> <html:errors  property="billingMethodName"  />
                           <html:hidden property="billingMethodId" styleClass="restaurant_input"  />
