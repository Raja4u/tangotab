...
<script type="text/javascript">
	...
	function submitForm(){
		...
		document.forms[0].action = "viewCitys.do?stateId="+${state};
                  ...
                  <tr>
                    <td align="center" valign="top"><br/>
                     <table width="60%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#cccccc">
                      ...
                      <tr height="20">
              					<td align="right" width="100" valign="middle" class="table_dark">
													...
													<td  align="left" valign="middle" class="table_dark">
														<html:select property="stateId" 
															styleClass="restaurant_select" styleId="stateId"  value="${state}">
                        ...
                        <td align="right" valign="middle" class="table_light">City Name<span class="red_text">*</span></td>
                        <td align="left" valign="middle" class="table_light"><span class="red_text">
                          <html:text property="cityName"/>
                        </span></td>
                      </tr>
                       <tr>
                        <td align="right" valign="middle" class="table_light">City Code<span class="red_text">*</span></td>
                        <td align="left" valign="middle" class="table_light"><span class="red_text">
                          <html:text property="cityCode"/>
                        </span></td>
                      </tr>
                      <tr>
