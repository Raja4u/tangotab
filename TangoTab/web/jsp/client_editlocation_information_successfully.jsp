				              ...
				              <tr>
				                ...
				                <td width="952" height="222" align="center" valign="top"><br/>
				                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
				                    <tr>
				                      <td height="75" align="center" valign="top" class="red_max"><strong>Your details have been updated successfully.
				                      	<c:if test="${userInfo.noOfLocations gt userInfo.noOfEnteredLocatios}">
				                      		To add another location click 'Add'.
				                      	</c:if>
				                      </strong>
				                      </td>
				                    </tr>
				                    <tr>
				                      <td align="center" valign="top"><table width="100" border="0" align="center" cellpadding="0" cellspacing="0">
				                        <tr>
				                          <td align="center" valign="top" id="select_hot">
				                          <a href="createDeal.do" style="" >Close</a>
				                         </td>
				                           <c:if test="${userInfo.noOfLocations gt userInfo.noOfEnteredLocatios}">
				                             <td align="center" valign="top" id="select_hot">	<a href="createLocation.do">Add</a>
				                             </td>  </c:if>
