                ...
                <td width="952" height="100" align="center" valign="top"><table width="935" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td align="center" valign="top"><br/> 
                            ...
                            <html:form action='/jsp/cuisineTypes'>      
         		<table width="60%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#cccccc">
                      <tr>
                        <td align="right" valign="middle" class="table_light">Cuisine Type<span class="red_text">*</span>:</td>
                        <td align="left" valign="middle" class="table_light"><span class="red_text">
                          <html:text property="type" styleClass="restaurant_input"  /> <html:errors  property="type"  />
                           <html:hidden property="cuisineTypeId" styleClass="restaurant_input"  />
