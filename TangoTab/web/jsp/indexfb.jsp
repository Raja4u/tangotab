...
var ua = navigator.userAgent;
 ...
 if(ua.indexOf('iPhone') != -1 || ua.indexOf('iPod') != -1  
	...
	{ 
      window.location="http://184.173.113.66/mobile/signup/";
	  return true;
...
<body onload="getStat();getLoginCookie();placeHolderFields('emailId,lastname,password,zipCode,firstname');getCookie('landing')" >
											<div id="fb-root"></div>
<script>
  window.fbAsyncInit = function() {
    FB.init({
      appId      : '216686028341782', // App ID
      channelUrl : '//www.tangotab.com/channel.html', // Channel File
                      ...
                      <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
                                <td colspan="3" align="left" valign="top" class="text_homebold_2" scope="row" height="70">&nbsp;</td>
                              </tr>
							  <tr> 
                              ...
                              <tr>
                                <td colspan="3" align="left" valign="top"  scope="row"><h2> People dine out <span >1,000,000,000</span> times a<br/> week in North America.
                              ...
                              <tr>
                                <td colspan="3" align="left" valign="top" ><h3>TangoTab donates a meal to people in need every<br/> time you use the service.
<span class="text_homebold_orange" style="font-size: 22px;"><i>&nbsp;When you eat, they eat</i></span>.</h3>  </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td colspan="3" align="left" valign="top" class="text_homebold_2" scope="row" height="100">&nbsp;</td>
                              </tr>
							  <tr>
...
<span id="counter"><input type="hidden" name="counter-value" value="${charityCount}" /></span>
<script type="text/javascript">
/* <![CDATA[ */
...
/* ]]> */
    ...
    <td width="38%" valign="bottom"> people in need.</td>
                                          ...
                                          <tr>
                                            <td height="40" align="center"  >
                                              <!-- <html:text property="firstname" 	styleClass="text_box" styleId="firstName" value="First Name" onclick="this.value=((this.value=='First Name')?'':this.value);" onfocus="this.select()" onblur="this.value=!this.value?'First Name':this.value;"  ></html:text> 
             								  --> <input type="text" name="firstname" id="firstname" placeholder="First Name" class="text_box"  /> </td> </tr>
                            ...
                            <td height="25" align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td width="89%" class="normalwht">I agree to the <a href="terms.jsp" class="normalwht">Terms &amp; Conditions</a></td>
                                          ...
                                          <tr>
                                            <td align="center" valign="top" scope="row">
                                            <a href="#" onclick="Onsubmit1();"><img src="../images/signup_btn.png"   border="0" /></a>
                                            </td>
                                          </tr>
                                            <tr>
                                            <td scope="row">&nbsp;</td>
                                          ...
                                          <tr>
                                            <td scope="row" align="center"><img src="../images/line_img.png" alt="img"  /></td>
                                          </tr>
                                          <tr>
                                            <td scope="row">&nbsp;</td>
                                          </tr>
		...
		<div id="fb-root"></div>									
	<script src="https://connect.facebook.net/en_US/all.js#appId={216686028341782}&xfbml=1"></script>
<script>
...
FB.getLoginStatus(function(response) {
 ...
 //alert(FB.getLoginStatus);
	...
	<script>
	function doLogin(){
	window.location="http://www.tangotab.com/jsp/searchForward.do";
	}
	</script>							
                                          <fb:login-button registration-url="http://www.tangotab.com/jsp/delete.jsp" 
   											      on-login="doLogin()" >
   											      </fb:login-button>
                                            </td>
                                          </tr>
