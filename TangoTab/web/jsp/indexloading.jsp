                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <html:form  action="jsp/userReg.do?type=consumer" method="post" onsubmit="return Onsubmit1();">
                      ...
                      <tr>
                        <td height="450" align="center" valign="top" background="../images/signup_bg.png"><table width="85%" border="0" cellspacing="4" cellpadding="4">
                          <tr>
                            <td height="55">&nbsp;</td>
                          </tr>
                          <tr>
                            <td height="30" align="center" valign="middle">
                            <a href="#" onclick="centerPopup();loadPopup();"><img src="../images/signup_img.png" width="168" height="53" /></a></td>
                          </tr>
                          <tr>
                            <td height="50">&nbsp;</td>
                          </tr>
                            ...
                            <html:text property="firstname" 
                          	...
                          	<tr>
									<td> 	<html:text property="lastname" value="Last Name"	
													...
													<tr>
														<td><html:text property="emailId" value="Email"  onblur="checkEmail(4,this.value)" 	 styleClass="text_box" styleId="emailId"   onchange="removetext(this,'Email');"   onclick="removetext(this,'Email');"  onkeyup="removetext(this,'Email');" ></html:text> 
												                     </td></tr>
													<tr><td > 
                    ...
                    <td align="center" valign="top" height="445" ><table width="600" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="498" height="500" align="right" valign="top" style="background:url('../images/howtotango_bg.png') no-repeat;"><table width="72%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td height="165" align="left" valign="top">&nbsp;</td>
                          </tr>
                          <tr>
                            <td align="left" valign="top"><a href="search.do"><img src="../images/sampledeal.png" width="275" height="69" border="0" /></a></td>
                          </tr>
                          <tr>
                            <td height="130" align="left" valign="top">&nbsp;</td>
                          </tr>
                          <tr>
                            <td align="right" valign="top"><a href="charity.jsp"><img src="../images/widget_new.png" alt="Hungry" width="180" height="127" border="0" /></a></td>
                          </tr>
                        </table></td>
                      </tr>
                    </table></td>
