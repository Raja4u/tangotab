...
<!--			        <html:form action="/jsp/newdescription" method="post">-->
						<!-- form Start-->
              ...
              <tr>
                ...
                <table width="935" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30" align="center" valign="middle" class="red_max"> Add Credits</td>
                  </tr>
                     ...
                     <table width="60%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#cccccc">
                      <tr height="20">
              					<td align="right" width="100" valign="middle" >
														<span class="bla_low">No Of Credits<span
															class="red_text">*</span>:</span><br /></td>
								<td align="left" valign="middle" >&nbsp;&nbsp;
											<input type="text" name="credits" id="credits" class="restaurant_input" id="credits" onkeypress="return isNumberKey(event)"></input>
											&nbsp;<span id="alert" style="red_text" class="red_text"></span></td>
												</tr>  
						
				      <tr>
                        <td align="right" valign="middle" class="table_light">
                                         <span class="bla_low">Description<span class="red_text">*</span>:</span></td>
                        <td align="left" valign="middle" class="table_light">
                          <input type="text" name="desc"  id="desc" class="restaurant_input" value="Administrator added"></input>
                      ...
                      <tr>
                        ...
                        <table width="110" border="0" align="left" cellpadding="0" cellspacing="5">
                          <tr>
                            ...
                            <html:submit property="operation" styleClass="but_img" value="AddCredits" onclick="return check();">Save</html:submit>
                            </div></td>
                            <td ><div id="select_hot">
