...
<body onload="getLoginCookie();" onclick="clickedBody(this.id);">
                  ...
                  <tbody><tr>
                    <td align="right" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="left" valign="top"class="row"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="left" valign="top" scope="row">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td colspan="3" align="left" valign="top" class="text_homebold" scope="row"> Americans dine out <span class="text_homebold_orange">1,000,000,000</span><br/> times a week. </td>
                              </tr>
                              <tr>
                                <td height="20" colspan="3" align="left" valign="top" scope="row"></td>
                              </tr>
                              <tr>
                                <td colspan="3" align="left" valign="top" class="text_homebold" scope="row">What if every time you dined out, <br/>a person in need was also fed? </td>
                              </tr>
                              <tr>
                                <td colspan="3" scope="row">&nbsp;</td>
                              </tr>
                              <tr>
                                <td  width="23%" align="left" valign="top" class="text_homebold_1" scope="row">Free Service. </td>
                                <td  width="23%"  align="left" valign="top" class="text_homebold_1" scope="row">Free Offers. </td>
                                <td  align="left" valign="top" class="text_homebold_1" scope="row"><span class="text_homebold_2">Great Cause.</span></td>
                              </tr>
                                ...
                                <td height="450" align="center" valign="top" bgcolor="#141414"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    <td align="center" valign="top" class="padding1" scope="row"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr>
                                        <td align="center" valign="top" class="signup_txt" scope="row">Sign Up Now ! </td>
                                      </tr>
                                      <tr>
							...
							<input type="hidden" name="emailIdexists"	 id="emailIdexists" />			
									...
									<table width="65%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            ...
                                            <html:hidden property="refferCode"  value="1043" styleId="refferCode" />  <html:text property="firstname" 
                                ...
                                <td width="89%" class="normalwht">I agree to the <a href="terms.jsp" class="normalwht">Terms &amp; Conditions</a></td>
                                          ...
                                          <tr>
											...
											<div style="float;padding-left:20px;">
												<a href="#"> <img src="../images/f_connect_btn.png" border="0" /> </a>
											</div></div>
