...
<%@ page import="com.tangotab.dao.pojo.BillingType"%>
			...
			<div class="main_cantainer">
				<div class="cantainer_content">
					...
					<div class="inner_cantainer">
						<div class="main_deal">
							...
							<div class="content_deal_inner"><table width="760" border="0" cellspacing="0" cellpadding="0">			  
				<%@ include file="admin_banner.jsp" %>
			    <tr>
			        <td height="17" colspan="3" align="center" valign="top">
			        <html:form action="/jsp/viewRestrictions" method="post">
						<!-- form Start-->
              ...
              <tr>
                ...
                <td width="952" height="100" align="center" valign="top"><table width="935" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30" align="center" valign="middle" class="red_max">  Manage Deal Restrictions</td>
                  </tr>
                  ...
                  <tr>
                    <td align="center" valign="top"><br/>
                        <table width="30%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#cccccc">
                          <c:if test="${ not empty dealrest}">
                          <tr>
                            <td height="24" align="center" valign="middle" class="text_h3">Restriction</td>
                            <td align="center" valign="middle" class="text_h3">Status</td>
                          </tr>
                          <c:forEach var="rest" items="${dealrest}">
                                                   
                          <tr>
                            <td align="left" valign="middle" class="table_dark">
                           <html:hidden property="restrictionId" styleId="restrictionId" value="${rest.restrictionId}" /> 
                           <html:hidden property="restriction" value="${rest.restriction}" />
                           <input type="hidden" name="changestatus" id="changestatus" value="0"/>
                            <a href="viewRestrictions.do?operation=edit&id=${rest.restrictionId }" class="bla_low"><u>${rest.restriction }</u></a></td>
                            <td align="left" valign="middle" class="table_dark"> 
                           <select name="isActive" >
                           <option value="1"  <c:if test="${rest.isActive eq 1 }"><% out.print("selected='selected';");%> </c:if> >Active</option>
                           <option value="0"  <c:if test="${rest.isActive eq 0 }"><% out.print("selected='selected';");%> </c:if> >InActive</option>
                           </select>
                            </td>
                          </tr>
                          </c:forEach>
                        ...
                        <tr>
                            <td height="30" align="right" valign="middle" class="table_light"><table width="75" border="0" align="right" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="center" valign="middle"><div class="login_butgre"><a href="admin_newrestriction.jsp">New</a></div></td></tr>
                            </table></td>
