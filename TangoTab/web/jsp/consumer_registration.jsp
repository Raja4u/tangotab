...
for (i=0;i<ARRcookies.length;i++)
{
  ...
  if (x==c_name)
    {
    //alert(isNumber(y));
    /* If it is number , the code coming from landing pages */
    if(isNumber(y)){
		...
		<script type="text/javascript">
		 ...
		 function Onsubmit1(){
				...
				if(document.userForm.password.value=="" || document.userForm.password.value.length==0)
				{
				 ...
				 return false;
				}else if(document.userForm.password.value.length<6)
				{
				...
				}else if(document.userForm.cpassword.value=="" || document.userForm.cpassword.value.length==0)
				{
				 ...
				 return false;
				}else if(document.userForm.cpassword.value.length<6)
				{
				...
				}else if(document.userForm.agree.checked==false)
				{
				 ...
				 return false;
				}else if(validateZipCode(document.userForm.zipCode.value) == false){
				    //alert('false');
...
function checkPassword(id)
{
   ...
   //alert(id.value.length);
	...
	<body onload="getCookie('landing');delete_cookie('showhidt');"> 
		<div id="wrapper">
		<div id="main">
  ...
  <table width="965" border="0" cellspacing="0" cellpadding="0" class="form_txt">
												...
												<logic:present name="message">
													...
													<tr>
														...
														<td  align="left" valign="middle">
															...
															<html:hidden property="refferCode"  value="<%=refferCode %>" styleId="refferCode"/>
															<input type="hidden" id="share" name="share" value="${share}" />
															<input type="hidden" id="refferedUrl" name="refferedUrl" value=""/>
															<input type="hidden" id="dealsource" name="dealsource" value=""/></td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td><div class="blue_text" style="font-size:11px; color:grey;" >Password should contain minimum six alphanumeric characters</div>
																<div id="strength" style="float:left;color:green;font-weight:bold;"></div> 
																	<span  class="red_text" id="pwd"><html:errors property="password" /></span></td>
													</tr>
													<tr>
														<td align="right" valign="middle" class="text_formsub">
			                ...
			                <td align="left" valign="middle">
							<html:select property="preferCity"  styleClass="listboxeffect" style="width:150px; border-color:#000000;" styleId="preferCity"   >
			    			...
			    			<html:options collection="relationships2" property="cityId" labelProperty="cityName"/>
													...
													--><tr>
														...
														<td><div style="font-size:11px; color:grey;">(e.g., 2125551212)&nbsp;&nbsp;[If you would like to be notified of deals via SMS*] </div>
												...
												<tr>
														...
														<table><tr><td valign="top"><input type="checkbox" class="text_agree" name="agree" id="checkbox24"  value="ok"/>
															</td>
															<td>I certify that I have read and agree to the
															<span class="text_h8"> <a href="privacy_policy.jsp"
																class="red_text"  target="_blank" >privacy policy</a></span> and
														
														
															<a href="terms.jsp"  class="red_text" target="_blank">terms of use</a> of TangoTab.</td>
															</tr></table>
													...
													<tr>
														<td colspan="4" align="center" valign="middle">
															<table width="305" border="0" align="center" style="padding-left:181px;"
