<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="com.tangotab.dao.pojo.CuisineType"%>
...
List<CuisineType> cuisine=com.tangotab.businessImpl.BusinessFactory.getBillingMethodsBO().getCuisineTypes();
		...
		<div class="cantainer_inner">
			<div class="main_cantainer">
			    ...
			    <tr>
			        ...
			        <html:form action="/jsp/cuisineTypesdisplay" method="post">
						<!-- form Start-->
              ...
              <tr>
                ...
                <td width="952" height="100" align="center" valign="top"><table width="935" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td height="30" align="center" valign="middle" class="red_max">  Manage Cuisine Types</td>
                  </tr>
                  ...
                  <tr>
                   ...
                   <tr>
                            <td height="24" align="center" valign="middle" class="text_h3">Cuisine Type</td>
                   ...
                   %>
                          <tr>
                            ...
                            <html:hidden property="cuisineTypeId" value="<%=Integer.toString(cuisineType.getCuisineTypeId()) %>" />
                            <html:hidden property="type" value="<%=cuisineType.getType() %>" />
                            <a href="cuisineTypesdisplay.do?operation=insert&id=<%=cuisineType.getCuisineTypeId() %>" class="bla_low"><u><%=cuisineType.getType() %></u></a></td>
                            <td align="left" valign="middle" class="table_dark"> 
                           <select name="isActive">
                           <option value="1"  <% if(cuisineType.getIsActive()==1) out.print("selected='selected';"); %> >Active</option>
                           <option value="0" <% if(cuisineType.getIsActive()==0) out.print("selected='selected';"); %> >InActive</option>
                           </select>
                            </td>
                          </tr>
                        ...
                        <!--  <tr>
                          ...
                          <tr>
                            <td height="30" align="right" valign="middle" class="table_light"><table width="75" border="0" align="right" cellpadding="0" cellspacing="0">
                              <tr>
                                <td align="center" valign="middle"><div class="login_butgre"><a href="cuisineTypesdisplay.do?operation=insert&type=new">New</a></div></td>
                              </tr>
                            </table></td>
