                ...
                <td height="100" align="center" valign="top"><table width="945" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td align="center" valign="top"><table width="98%" border="0" align="center" cellpadding="0" cellspacing="5">
                     ...
                     <td><div id="select_hot"><html:submit property="operation" value="Search" styleId="search" styleClass="login_red" onclick="return check();">Search</html:submit></div></td>
                     <!--<td><div id="select_hot">
                     <input type="submit" class="but_img"  name="submitID" value="Search" onclick="submitForm()"/></div></td>
                          --><td align="center" valign="middle">
                          <table width="220" border="0" align="center" cellpadding="0" cellspacing="0">
                            <tr>
                           <!--<td><div id="select_hot"><html:submit property="operation" value="Search" styleId="search" styleClass="login_red" onclick="return check();">Search</html:submit></div></td>
                           --><td><div id="select_hot"><html:submit property="operation" value="Add" styleClass="login_red">Add</html:submit></div></td>
                              <td><div id="select_hot"><html:submit property="operation" value="Reduce" styleClass="login_red">Reduce</html:submit></div></td>
                            </tr>
                          </table></td>
                        </tr>
                    </table></td>
                    ...
                    <c:if test="${not empty trans}">
                        <table width="98%" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#cccccc">
                          <tr>
                            ...
                            <td align="left" valign="middle" class="text_h3">Credit</td>
                            <td align="left" valign="middle" class="text_h3">Debit</td>
                            <td align="left" valign="middle" class="text_h3">Current</td>
                            <td align="left" valign="middle" class="text_h3">Description</td>
                            <td align="left" valign="middle" class="text_h3">Email</td>
