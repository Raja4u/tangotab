	...
	<div class="head_top">
		<div class="logo">
			<c:if test="${not empty userInfo}">
				<a href="<fmt:message key='website.home'></fmt:message>/jsp/charity.jsp"> <img src="../images/tango_tablogo.png"
						border="0" /> </a>
			</c:if>
			<c:if test="${ empty userInfo}">
				<a href="<fmt:message key='website.home'></fmt:message>/jsp/index.jsp"> <img src="../images/tango_tablogo.png"
						border="0" /> </a>
			</c:if>
		</div>
		<div class="navigtiion">
			...
			<c:if test="${ empty userInfo and  empty profileUsers}">
				<div class="signin">
					...
					<a href="<fmt:message key='website.home'></fmt:message>/jsp/login.jsp">Sign in</a><a
...
<table><tbody><tr><td height="75px;"></td></tr></tbody></table>
...
<!--Added the Email Dialog Here - Social Integration-->
			...
			<div id="popupContact">
             ...
             redirect_uri=<fmt:message key='website.home'></fmt:message>/jsp/Face.do&
             fields=[
 {'name':'name'},
 {'name':'email'},
