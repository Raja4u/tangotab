				...
				<tr> 
					<td width="653" align="center" valign="top" class="text_h9"> 
					  ...
					  <table cellpadding="0" cellspacing="0" border="0"> 
				  		<tr>
							<td valign="top" align="left" width="900" style="font-size:14px; line-height:1.5;"><p>TangoTab makes it easy for eWomenNetwork to raise funds.  Simply, connect your friends, family and colleagues with TangoTab, a free service that provides them with hot deals at their favorite restaurant. <br>
							  <br>
							</p>							  
							  <table width="900" border="0">
							    <tr>
							      <td width="396"><p style="color:#e09e09; font-size:16px; text-align:left;"><strong>Benefits to registered users of TangoTab</strong></p></td>
							      <td width="494"><p style="color:#e09e09; font-size:16px; text-align:left;"><strong>Aside from the free benefit that each member gets through discounted dining offers…
</strong></p></td>
						        </tr>
					      </table></td>
						</tr>
					  ...
					  <table border="0">
					    <tr>
					      <td width="395"><ul>
					        <li style="font-size:14px; line-height:1.5;">Great discounts at favorite restaurants</li>
					        <li style="font-size:14px; line-height:1.5;">Pay the restaurant directly, no prepayment</li>
					        <li style="font-size:14px; line-height:1.5;">Search for deals or restaurants</li>
					        <li style="font-size:14px; line-height:1.5;">Share deals with friends</li>
					        <li style="font-size:14px; line-height:1.25;">Earn rewards for referrals and reviews</li>
				          </ul></td>
					      <td width="25" style="font-size:14px; line-height:1.75;" valign="top"><p><img src="images/tick.png" width="16" height="16" align="bottom"></p>
					        <p>&nbsp;</p>
					        <p><br>
					        </p>
				          <p><img src="images/tick.png" alt="" width="16" height="16" align="baseline"></p></td>
					      <td width="436" style="font-size:14px; line-height:1.5;">
         TangoTab will provide eWomenNetwork with revenue sharing for every member that joins and uses the TangoTab program.<br>
                            eWomenNetwork could offer funds raised as charitable donations or causes of their choice. </td>
				        </tr>
				      </table>
					  <table valing="center" width="900" border="0">
				        <tr>
				          <td width="350" align="center"><p><img src="images/sampledeal.jpg" width="433" height="190"></p>
			              <p>&nbsp;</p>
			              <p>&nbsp;</p></td>
				          <td valign="middle" align="center">
						  	<a href="http://tangotab.com/jsp/consumer_registration.jsp?refferCode=1002"><img src="images/sign-up-button.jpg" border="0"></a>
							<br>
							<br>
							<a href="http://www.tangotab.com/refer/referfriends.jsp"><img src="images/refer-button.jpg" border="0"></a>
                          </td>
			            </tr>
			          </table>
			        <p>&nbsp;</p></td> 
