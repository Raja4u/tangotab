...
<%
 String emailTo = "ttewomen@gmail.com";
 String emailFrom = "ttewomen@gmail.com"; 
 ...
 try
  {
	 ...
	 msg.println( "Subject: TangoTab.com eWoman Registration" + "\r\n" );
 	    ...
 	    <table cellpadding="5" cellspacing="0" border="0" width="900" align="center">
 	      <tr>
 	        ...
 	        <td width="500" align="center" valign="top" class="strong">
 	          ...
 	          <% } else { %>
 	          <div class="title2">
 	            Thank you for joining the eWomenNetwork TangoTab program!  
 	            </div>
 	          <br>
 	          <p align="center" style="font-size:16px; line-height:1.75"><strong>You will be receiving an email from us shortly.</strong> <br>
 	            You can start accruing funds for eWomenNetwork charities today by clicking the link below and signing up friends and family to receive awesome deals: <br>
