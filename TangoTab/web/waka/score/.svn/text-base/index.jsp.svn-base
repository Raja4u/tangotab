...
var checker = {
 ...
 if(ua.indexOf('iPhone') != -1 || ua.indexOf('iPod') != -1 
	...
	{
    // document.getElementById("wrapper").style.diplay="none";   
 	
    window.location="<fmt:message key='website.home'></fmt:message>/waka/score/index2.jsp";
...
<body onload="setCookie('landing','1057',0);" >
...
<div class="cantainer3" >
  ...
  <tbody><tr>
  <td  align="center">
  <table width="1000" align="center" cellpadding="0" cellspacing="0" ><tbody><tr><td>
  <div style="overflow:auto; height:450px; width:880px; margin:20px 0 0 10px;"><img src="../images/waka_score.png" width="860" /></div></td></tr></tbody></table></td>
 </tr>
        </tbody></table>
