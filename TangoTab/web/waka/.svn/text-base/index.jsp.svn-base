	  ...
	  x=x.replace(/^\s+|\s+$/g,"");
			...
			//	 alert(y);
				 ...
				 document.loginForm.password.value=details[0];
						      document.loginForm.action="http://184.173.113.66/jsp/login.do";
		 ...
		 function Onsubmit1(){
			...
			else
			{
			  ...
			  document.getElementById("refferedUrl").value=window.location;
					 document.forms[0].action = "http://184.173.113.66/jsp/loginReg.do?type=consumer";
...
<body onload="getLoginCookie();setCookie('landing','1057',0);" >
...
<img src="http://184.173.113.66/images/corner_left.jpg" align="left" /><img src="http://184.173.113.66/images/corner_right.jpg" align="right" /></div> 
       ...
       <tr style="height:50px;">
		...
		<tr>
		 ...
		 Finding Offers Near You... <br/><br/>
		  ...
		  <td style="width:40px; height:35px;"><img src="http://184.173.113.66/images/loading-new.gif" alt="loading" border="0px;" style="width:150px; height:16px;" />
		  </td>
		  </tr>
		  <tr style="height:50px;">
		  <td style="height:40px;">
...
<div class="top_bottom">
    <img src="http://184.173.113.66/images/corner_bottom_left.jpg" align="left" /><img src="http://184.173.113.66/images/corner_bottom_right.jpg" align="right" /></div>
                      ...
                      <tr>
                        ...
                        <tr><td height="60"> &nbsp;</td></tr>
                          <tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
							  <tr> 
                                <td  width="41%" align="left" valign="top" class="text_homebold_1" scope="row"><a href="<fmt:message key='website.home'></fmt:message>jsp/searchForward.do" >Free Dining Service. </a></td>
...
<span class="text_homebold_orange" style="font-size: 22px;"><i>&nbsp;When you eat, they eat</i></span>.  </td>
						  ...
						  <tr><td> <img src="<fmt:message key='website.home'></fmt:message>waka/images/waka.png" border="0"  /></td></tr>
						  <tr><td height="18"> </td></tr>
						   <tr>
...
<script src="http://184.173.113.66/js/jquery.flipCounter.1.2.js" type="text/javascript"></script>	
<span id="counter"><input type="hidden" name="counter-value" value="82456" /></span>
<script type="text/javascript">
/* <![CDATA[ */
...
<input type="text" name="emailId" id="emailId" placeholder="Email" class="text_box" /></td></tr>
                            ...
                            <td height="25" align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td width="89%" class="normalwht">I agree to the <a href="http://184.173.113.66/jsp/terms.jsp" class="normalwht">Terms &amp; Conditions</a></td>
                              </tr>
                            </table></td>
                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                            <td align="center" valign="top" scope="row">
                                            <a href="#" onclick="Onsubmit1();"><img src="http://184.173.113.66/images/signup_btn.png"   border="0" /></a>
                                            </td>
                                          </tr>
                                            <tr>
                                            <td scope="row">&nbsp;</td>
                                           ...
                                           <tr>
                                            ...
                                            <a href="http://184.173.113.66/jsp/login.jsp" class="text_signin_txt"> Sign In </a></span></td>
                                          </tr>
                                          <tr>
                                            <td scope="row">&nbsp;</td>
                                          </tr>
                                          <tr>
                                            <td scope="row" align="center"><img src="http://184.173.113.66/images/line_img.png" alt="img"  /></td>
                                          </tr>
                                          <tr>
                                            <td scope="row">&nbsp;</td>
                                          </tr>
                                          <tr>
											...
											<div style="float;padding-left:20px;">
												<a href="#"> <img src="http://184.173.113.66/images/f_connect_btn.png" border="0" /> </a>
											</div></div>
