...
<body id="body" topmargin="0" bottommargin="0" onload="setCookie('landing','1039',0);"  onclick="clickedBodyUtil();">
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <html:form  action="jsp/userReg.do?type=consumer" method="post" onsubmit="return Onsubmit1();">
							...
							<html:hidden property="refferCode"  value="1039" styleId="refferCode"/>
