				  ...
				  <div class="mediumorange">
					...
					<table cellspacing="10" border="0">
								...
								<!-- <html:form  action="jsp/userRegs.do?type=consumer" method="post" onsubmit="return Onsubmit1();"> -->
									...
									<input type="hidden" name="pageSource" id="pageSource" value="http://www.tangotab.com/minniesfoodpantry/submitsignup.jsp">
									<!-- ********** Page to return to after submit is complete *********** -->
							...
							<tr>
								...
								<td  align="left" valign="middle">
									...
									<input type="text" name="FirstName" id="FirstName" class="restaurant_input"> 
										 
									<input type="hidden" name="refferCode"  value="1006"/>
								</td>
							</tr>
							<tr>
								...
								<td align="left" valign="middle">
								<input type="text" name="LastName" id="LastName" class="restaurant_input"> 
										...
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
										  <tr>
											<td width="163" align="left" valign="top">
												<input type="text" name="Email"  onblur="checkEmail(4)" id="Email"  class="restaurant_input" />
											 </td>
