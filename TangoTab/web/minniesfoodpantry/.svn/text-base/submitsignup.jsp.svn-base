	 ...
	 mailText= mailText+ ( "Email: " + request.getParameter( "Email" ) + "<br />" );
	  ...
	  mailText= mailText+ ( "Phone Number: " + request.getParameter( "Phone" ) + "<br />" );
	   ...
	   TangoTabMailer.sendEmail(emailTo,
					null, 
					"TangoTab.com Minnie's FOOD PANTRY User Registration", mailText); 
...
<div id="wrap"> 
	...
	<tr>
	  <td align="center" valign="top" background="images/submitsignup_bg.jpg" height="558"><table width="500" border="0" cellspacing="0" cellpadding="0">
	    <tr>
	      <td height="420">&nbsp;</td>
	      </tr>
	    <tr>
