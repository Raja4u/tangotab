...
String emailTo = "rathnakar.p@techgene.com";
 ...
 String HOLDER_EMAIL="#HOLDER_EMAIL#";
     String personalMail="";
     String personalHeader="Minnie's FOOD PANTRY Friend Referal";
	 String mail = "";
	...
	+" Feeding the world's hungry... one reservation at a time";
	  ...
	  if(request.getParameter( "Name" ).length()>0 && request.getParameter("Email").length()>0)	
      {
       TangoTabMailer.sendEmail(emailTo,
					null, 
					"Minnie's FOOD PANTRY Friend Referal", mailText); 
      }
	...
	<tr>
		...
		<td width="300" valign="top" align="center">
			  ...
			  <table width="300" border="0" cellspacing="0" cellpadding="0">
			    <tr>
			      <td align="center" valign="top" class="right_bottom_border"><img src="images/thanku_img2.jpg" width="295" height="265"></td>
		        </tr>
			    <tr>
			      <td height="50">&nbsp;</td>
		        </tr>
			    <tr>
			      <td height="250" align="center" valign="top"><img src="images/suppoting_minnies2.jpg" width="194" height="229"></td>
		        </tr>
        </table></td>
		...
		<td width="667" valign="top" align="center" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
		    <td height="150" align="center" valign="top" class="mediumblack2">By using TangoTab to eat at your favorite restaurants, you're helping Minnie's Food Pantry provide nutritious meals for families and individuals in Plano, Texas.</td>
	      </tr>
		  <tr>
