...
var checker = {
 ...
 if(ua.indexOf('iPhone') != -1 || ua.indexOf('iPod') != -1 || ua.indexOf('iPad') != -1 
   ...
   window.location="http://www.tangotab.com/mobile/feedthechildren/";
...
<body onload="getLoginCookie();setCookie('landing','1059',0);" >
...
<span class="text_homebold_orange" style="font-size: 22px;"><i>&nbsp;When you eat, they eat</i></span>.  </td>
						  ...
						  <tr><td>  <a href="https://secure2.convio.net/ftc/site/Donation2?df_id=4080&4080.donation=form1&s_src=TopRight_SS&s_subsrc=spring&JServSessionIdr004=1rhxb705w1.app223a" target="_blank"><img src="images/together.png" border="0"  /></a>
						  </td></tr>
						  <tr><td height="18"> </td></tr>
						   <tr>
							...
							<input type="hidden" name="emailIdexists"	 id="emailIdexists" />			
									...
									<table width="65%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            ...
                                            <html:hidden property="refferCode"  value="1059" styleId="refferCode" /> 
...
<input type="text" name="emailId" id="emailId" placeholder="Email" class="text_box" /></td></tr>
                            ...
                            <td height="25" align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td width="89%" class="normalwht">I agree to the <a href="../jsp/terms.jsp" class="normalwht">Terms &amp; Conditions</a></td>
                              </tr>
                            </table></td>
                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                           ...
                                           <tr>
                                            ...
                                            <a href="../jsp/login.jsp" class="text_signin_txt"> Sign In </a></span></td>
                                          </tr>
                                          <tr>
                                            <td scope="row">&nbsp;</td>
                                          </tr>
