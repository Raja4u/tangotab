...
<div id="wrap"> 
	...
	<tr>
		...
		<!------------------------------ RIGHT COLUMN ------------------------------>
		<td width="667" background="images/backdrop.png" valign="top">
			...
			<tr>
				<td width="667" valign="middle" align="center" class="largewhite">
					Simply connect your friends, family and colleagues with TangoTab, a free service 
					that provides consumers with hot deals at their favorite restaurants. <br>
					<br>
				</td>
			</tr>
			<tr>
				<td width="667" valign="top" align="center" class="white_madium">
					<br><br><br><br><br><br>
					<br><br><br><br><br><br>
					<br><br><br><br>
					
					<a href="signup.jsp">
						<img src="images/signup.png" border="0" align="absmiddle">
					</a>
			...
			<tr>
				<td width="667" valign="middle" align="center" class="largewhite">
					<br>
					<br>
					TangoTab & Shaun Proulx Media will donate a portion of proceeds from
					each reservation to <font style="font-weight:bold; font-size:22px; color:#9999FF">THE JOY PROJECT</font>, helping to feed Canada’s hungry.  
					 <br>
