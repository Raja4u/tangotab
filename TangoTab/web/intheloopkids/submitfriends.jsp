...
String emailTo = "rathnakar.p@techgene.com";
 ...
 String HOLDER_EMAIL="#HOLDER_EMAIL#";
     String personalMail="";
     String personalHeader="In The Loop Kids Referal Friend";
	 String mail = "";
	...
	+" Feeding the world's hungry... one reservation at a time";
	  ...
	  if(request.getParameter( "Name" ).length()>0 && request.getParameter("Email").length()>0)	
      {
       TangoTabMailer.sendEmail(emailTo,
					null, 
					"In The Loop Kids Friend Referal", mailText); 
      }
	...
	{
		msg.println( "Subject: In The Loop Kids Friend Referal" 		 + "\r\n" );
	}
	else
	{
...
<div id="wrap"> 
	...
	<tr>
		...
		<td width="300" valign="top" align="center">
			...
			<img src="images/left2.png" border="0" align="bottom"><br>
		...
		<td width="667" valign="top" align="center" background="images/backdrop2.png">
			...
			<tr>
				<td align="center" valign="top" class="mediumblack">
					...
					You’re helping the eWomenNetwork Foundation to aide
					in the fight against hunger. The average person has a 
					social network of 669 people. Just by claiming a TangoTab 
					deal at a favorite restaurant once per month,
					the average person’s social network 
