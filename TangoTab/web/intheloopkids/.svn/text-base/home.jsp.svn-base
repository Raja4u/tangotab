...
<div id="wrap"> 
	...
	<tr>
		...
		<td width="300" valign="top" align="center">
			...
			<img src="images/left.png" border="0" align="bottom" width="300"><br>
		...
		<td width="667" background="images/backdrop.png" valign="top">
			...
			<tr>
				<td width="667" valign="middle" align="center" class="largewhite">
					<br>
					TangoTab will donate a portion of proceeds from each reservation to local and
					global organizations to feed the world’s hungry. <br>
