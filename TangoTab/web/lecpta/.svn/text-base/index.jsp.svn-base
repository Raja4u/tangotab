...
var checker = {
 ...
 if(ua.indexOf('iPhone') != -1 || ua.indexOf('iPod') != -1  
	|| ua.indexOf('BlackBerry') != -1 || ua.indexOf('Android') != -1 || ua.indexOf('RIM') != -1)
	{
     ...
     window.location="/mobile${errorPath}";
   //window.location="http://www.tangotab.com/mobile/lecpta/";
...
{
document.frm.action='<fmt:message key='website.home'></fmt:message>/jsp/searchForward.do';
document.frm.submit();
}
...
urlstring = '<fmt:message key='website.home'></fmt:message>/jsp/search.do?';
...
<body onload="getLoginCookie();setCookie('landing','1056',0);" >
          ...
          <tr>
            <td align="center" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tbody><tr>
				...
				<h1 style="line-height: 45px; font-family: calibri;"><span style="font-size:61px;"><a href="<fmt:message key='website.home'></fmt:message>jsp/searchForward.do"  style="color:#000000;text-decoration:none;">&nbsp;Free&nbsp;Restaurant&nbsp;Deals.</a></span>
							<br/>
                            ...
                            <tr>
                              ...
                              <tr>
                                <td height="10" colspan="3" align="left" valign="top" scope="row"></td>
                              </tr>
                              <tr>
                                <td height="20" colspan="3" align="left" valign="top" scope="row"></td>
                              </tr>
...
<span class="text_homebold_orange" style="font-size: 29px;"><i>&nbsp;When&nbsp;you&nbsp;eat,&nbsp;they&nbsp;eat</i></span>.</h2>  </td>
						  ...
						  <tr><td> <img src="<fmt:message key='website.home'></fmt:message>/lecpta/images/lec_pta.png" border="0"  /></td></tr>
						  <tr><td height="18"> </td></tr>
						   <tr>
							...
							<input type="hidden" name="emailIdexists"	 id="emailIdexists" />			
									...
									<table width="65%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            ...
                                            <html:hidden property="refferCode"  value="1056" styleId="refferCode" /> 
