...
var checker = {
 ...
 if(ua.indexOf('iPhone') != -1 || ua.indexOf('iPod') != -1  
  ...
  // window.location="http://www.tangotab.com/mobile/eataroundokc/";
...
<body onload="getLoginCookie();setCookie('landing','1051',0);" >
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          ...
                          <tr>
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
                             ...
                             <tr>
                                <td height="45" colspan="3" align="left" valign="top" scope="row"></td>
                              </tr>
...
<span class="text_homebold_orange" style="font-size: 29px;"><i>&nbsp;When&nbsp;you&nbsp;eat,&nbsp;they&nbsp;eat</i></span>.</h2>  </td>
                               ...
                               <tr>
                                <td height="53" colspan="3" align="left" valign="top" scope="row"></td>
                              </tr>
                              
                            </table>
                            
                           <div id="Layer2"><img src="<fmt:message key='website.home'></fmt:message>/eataroundokc/images/eataroundokc.png" border="0"  /></div> </td>
							...
							<input type="hidden" name="emailIdexists"	 id="emailIdexists" />			
									...
									<table width="65%" border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            ...
                                            <html:hidden property="refferCode"  value="1051" styleId="refferCode" /> 
