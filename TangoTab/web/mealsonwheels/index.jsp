...
<body topmargin="0" bottommargin="0" onload="setCookie('landing','1033',0);" onclick="clickedBody(this.id);" >
                        ...
                        <td height="480" align="center" valign="top" background="../images/fb_signup_bg.png">
                         <html:form  action="jsp/userReg.do?type=consumer" method="post" onsubmit="return Onsubmit1();">
                            ...
                            <tr>
                              ...
                              <tr>
                            <td>
							<html:hidden property="refferCode"  value="1033" styleId="refferCode" />
