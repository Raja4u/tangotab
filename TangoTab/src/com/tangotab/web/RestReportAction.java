...
public class RestReportAction extends BaseAction {
	public static Logger log = LoggerFactory.getLogger(RestReportAction.class);
	...
	public ActionForward performExecute(ActionMapping mapping, ActionForm form,
		...
		try
		{
	        ...
	        HSSFWorkbook workbook = userBo.createRestaurantWorkbook(userBo.getRestaurantReports());
	        response.setHeader("Content-Disposition", "attachment; filename=RestaurantDetails.xls");
