...
/**
 * <p>
 * Java class for ValidateCustomerPaymentProfileResponseType complex type.
 * 
 * <p>
...
@XmlType(name = "ValidateCustomerPaymentProfileResponseType", propOrder = { "directResponse" })
public class ValidateCustomerPaymentProfileResponseType extends ANetApiResponseType {
