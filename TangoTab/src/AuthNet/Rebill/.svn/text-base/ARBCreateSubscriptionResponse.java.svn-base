...
@XmlType(name = "", propOrder = { "arbCreateSubscriptionResult" })
...
public class ARBCreateSubscriptionResponse {
	 ...
	 * 
	 * @return possible object is {@link ARBCreateSubscriptionResponseType }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link ARBCreateSubscriptionResponseType }
	 * 
	 */
