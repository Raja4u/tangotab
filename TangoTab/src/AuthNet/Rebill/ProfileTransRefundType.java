...
@XmlType(name = "ProfileTransRefundType", propOrder = { "customerProfileId",
		"customerPaymentProfileId", "customerShippingAddressId", "creditCardNumberMasked",
		"bankRoutingNumberMasked", "bankAccountNumberMasked", "order", "transId" })
